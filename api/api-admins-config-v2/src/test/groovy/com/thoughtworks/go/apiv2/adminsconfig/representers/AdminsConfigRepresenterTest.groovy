...
class AdminsConfigRepresenterTest {
  ...
  void shouldSerializeToJSON() {
    ...
    final LinkedHashMap<String, Object> expected = ["_links": ["doc": ["href": "https://api.gocd.org/#system-admins"], "self": ["href": "http://test.host/go/api/admin/security/system_admins"]], "roles": ["xyz"], "users": ["admin"]]
  ...
  void shouldSerializeToJSONWithErrors() {
    ...
    final LinkedHashMap<String, Object> expected = ["_links": ["doc": ["href": "https://api.gocd.org/#system-admins"], "self": ["href": "http://test.host/go/api/admin/security/system_admins"]], "roles": ["xyz"], "users": ["admin"], "errors": ["roles": ["Role does not exist"], "users": ["User name cannot be blank"]]]
    assertThatJson(actualJson).isEqualTo(expected);
  }
