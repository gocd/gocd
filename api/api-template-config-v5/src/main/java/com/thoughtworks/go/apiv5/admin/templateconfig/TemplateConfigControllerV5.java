...
import com.thoughtworks.go.apiv5.admin.templateconfig.representers.TemplateConfigRepresenter;
import com.thoughtworks.go.apiv5.admin.templateconfig.representers.TemplatesConfigRepresenter;
...
public class TemplateConfigControllerV5 extends ApiController implements SparkSpringController, CrudController<PipelineTemplateConfig> {
    ...
    @Autowired
    public TemplateConfigControllerV5(TemplateConfigService templateConfigService, ApiAuthenticationHelper apiAuthenticationHelper, EntityHashingService entityHashingService) {
        super(ApiVersion.v5);
    ...
    public void setupRoutes() {
        path(controllerPath(), () -> {
            ...
            before("", mimeType, onlyOn(apiAuthenticationHelper::checkAnyAdminUserAnd403, "GET", "HEAD"));
