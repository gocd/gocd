...
describe ApiV5::Plugin::PluginInfoRepresenter do
  ...
  describe 'bad plugin info' do
    it 'should describe a BadPluginInfo object' do
      ...
      actual_json = ApiV5::Plugin::PluginInfoRepresenter.new(plugin_info).to_hash(url_builder: UrlBuilder.new)
  ...
  describe 'config repo plugin info' do
    it 'should describe a ConfigRepoPluginInfo object' do
      ...
      capabilities = com.thoughtworks.go.plugin.domain.configrepo.Capabilities.new(false, true)

      plugin_info = CombinedPluginInfo.new(ConfigRepoPluginInfo.new(descriptor, nil, plugin_settings, capabilities))
      actual_json = ApiV5::Plugin::PluginInfoRepresenter.new(plugin_info).to_hash(url_builder: UrlBuilder.new)
      ...
      expect(actual_json).to eq({
                                  ...
                                  extensions: [
                                    {
                                      type: 'configrepo',
                                      plugin_settings: ApiV5::Plugin::PluggableInstanceSettingsRepresenter.new(plugin_settings).to_hash(url_builder: UrlBuilder.new),
                                      capabilities: {
                                  ...
                                  extensions: [
                                    {
                                      ...
                                      scm_settings: ApiV5::Plugin::PluggableInstanceSettingsRepresenter.new(scm_settings).to_hash(url_builder: UrlBuilder.new),
                                    }
                                  ]})
    end
  end
                                  ...
                                  extensions: [
                                    {
                                      type: 'task',
                                      display_name: 'Foo task',
                                      task_settings: ApiV5::Plugin::PluggableInstanceSettingsRepresenter.new(task_settings).to_hash(url_builder: UrlBuilder.new),
                                    }
                                  ]})
    end
                                  ...
                                  extensions: [
                                    {
                                      ...
                                      package_settings: ApiV5::Plugin::PluggableInstanceSettingsRepresenter.new(package_settings).to_hash(url_builder: UrlBuilder.new),
                                      repository_settings: ApiV5::Plugin::PluggableInstanceSettingsRepresenter.new(repo_settings).to_hash(url_builder: UrlBuilder.new),
                                    }
                                  ]})
    end
  end
                                  ...
                                  extensions: [
                                    {
                                      type: 'elastic-agent',
                                      plugin_settings: ApiV5::Plugin::PluggableInstanceSettingsRepresenter.new(plugin_settings).to_hash(url_builder: UrlBuilder.new),
                                      profile_settings: ApiV5::Plugin::PluggableInstanceSettingsRepresenter.new(profile_settings).to_hash(url_builder: UrlBuilder.new),
                                      capabilities: ApiV5::Plugin::ElasticPluginCapabilitiesRepresenter.new(capabilities).to_hash(url_builder: UrlBuilder.new)
                                    }
                                  ]})
    end
  end
    ...
    it 'should describe an authorization plugin' do
      ...
      expect(actual_json).to eq({
                                  ...
                                  extensions: [
                                    {
                                      type: 'authorization',
                                      auth_config_settings: ApiV5::Plugin::PluggableInstanceSettingsRepresenter.new(auth_config_settings).to_hash(url_builder: UrlBuilder.new),
                                      role_settings: ApiV5::Plugin::PluggableInstanceSettingsRepresenter.new(role_config_settings).to_hash(url_builder: UrlBuilder.new),
                                      capabilities: ApiV5::Plugin::AuthorizationCapabilitiesRepresenter.new(capabilities).to_hash(url_builder: UrlBuilder.new)
                                    }
                                  ]})
    end
  end
    ...
    it 'should describe an artifact plugin' do
      ...
      expect(actual_json).to eq({
                                  ...
                                  extensions: [
                                    {
                                      type: 'artifact',
                                      capabilities: ApiV5::Plugin::ArtifactCapabilitiesRepresenter.new(capabilities).to_hash(url_builder: UrlBuilder.new),
                                      store_config_settings: ApiV5::Plugin::PluggableInstanceSettingsRepresenter.new(store_config_settings).to_hash(url_builder: UrlBuilder.new),
                                      artifact_config_settings: ApiV5::Plugin::PluggableInstanceSettingsRepresenter.new(artifact_config_settings).to_hash(url_builder: UrlBuilder.new),
                                      fetch_artifact_settings: ApiV5::Plugin::PluggableInstanceSettingsRepresenter.new(fetch_artifact_config_settings).to_hash(url_builder: UrlBuilder.new),
                                    }
                                  ]})
    end
  end
  ...
  describe 'plugin info with multiple extensions in it' do
    it 'should have multiple extensions' do
      ...
      actual_json = ApiV5::Plugin::PluginInfoRepresenter.new(plugin_info_with_multiple_extensions).to_hash(url_builder: UrlBuilder.new)
      ...
      expect(actual_json).to eq({
                                  ...
                                  extensions: [
                                    {
                                      type: 'notification',
                                      plugin_settings: ApiV5::Plugin::PluggableInstanceSettingsRepresenter.new(notification_plugin_settings).to_hash(url_builder: UrlBuilder.new)
                                    },
                                    {
                                      type: 'task',
                                      display_name: 'Foo task',
                                      task_settings: ApiV5::Plugin::PluggableInstanceSettingsRepresenter.new(task_plugin_settings).to_hash(url_builder: UrlBuilder.new),
                                    },
                                    {
                                      type: 'configrepo'
                                    }
