...
public class PackageMaterialUpdateWithExistingPackageDefinitionCommand extends PackageMaterialSaveCommand {
    public PackageMaterialUpdateWithExistingPackageDefinitionCommand(PackageDefinitionService packageDefinitionService, SecurityService securityService, String pipeline,
