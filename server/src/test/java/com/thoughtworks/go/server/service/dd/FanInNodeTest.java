...
public class FanInNodeTest {
    ...
    public void shouldNotCreateNodeForUnregisteredMaterials() {
        assertThatThrownBy(() -> FanInNode.create(new SomeRandomMaterialConfig()))
            .hasMessageContaining("Not a valid material type");
    }
}
