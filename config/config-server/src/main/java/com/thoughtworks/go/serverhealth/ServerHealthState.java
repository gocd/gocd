...
public class ServerHealthState {
    ...
    public static ServerHealthState warning(String message, String description, HealthStateType healthStateType) {
        return new ServerHealthState(HealthStateLevel.WARNING, healthStateType, StringEscapeUtils.escapeHtml4(message), StringEscapeUtils.escapeHtml4(description));
    }
    ...
    public static ServerHealthState warning(String message, String description, HealthStateType healthStateType, Duration timeout) {
        return new ServerHealthState(HealthStateLevel.WARNING, healthStateType, StringEscapeUtils.escapeHtml4(message), StringEscapeUtils.escapeHtml4(description), timeout);
    }
    ...
    public static ServerHealthState error(String message, String description, HealthStateType type) {
        return new ServerHealthState(HealthStateLevel.ERROR, type, StringEscapeUtils.escapeHtml4(message), StringEscapeUtils.escapeHtml4(description));
    }

    public static ServerHealthState error(String message, String description, HealthStateType type, Duration timeout) {
        return new ServerHealthState(HealthStateLevel.ERROR, type, StringEscapeUtils.escapeHtml4(message), StringEscapeUtils.escapeHtml4(description), timeout);
    }
