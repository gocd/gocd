...
public class PipelineConfigControllerV8 extends ApiController implements SparkSpringController, CrudController<PipelineConfig> {
    ...
    @Autowired
    public PipelineConfigControllerV8(PipelineConfigService pipelineConfigService, ApiAuthenticationHelper apiAuthenticationHelper, EntityHashingService entityHashingService, PasswordDeserializer passwordDeserializer, GoConfigService goConfigService) {
        super(ApiVersion.v8);
