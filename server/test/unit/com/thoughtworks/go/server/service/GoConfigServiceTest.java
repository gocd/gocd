...
public class GoConfigServiceTest {
    ...
    public void shouldSayThatAUserIsAuthorizedToViewAndEditTemplatesWhenTheUserHasPermissionsForAtLeastOneTemplate() throws Exception {
        ...
        assertThat(goConfigService.isAuthorizedToViewAndEditTemplates(new Username(new CaseInsensitiveString(theSuperAdmin))), is(true));
    ...
    public void shouldSayUserIsAuthorizedToViewTemplatesWhenTheUserHasViewPermissionsToAtLeastOneTemplate() {
        ...
        assertThat(goConfigService.isAuthorizedToViewTemplates(new Username(templateAdminName)), is(true));
        assertThat(goConfigService.isAuthorizedToViewTemplates(new Username(templateViewUser)), is(true));
        assertThat(goConfigService.isAuthorizedToViewTemplates(new Username(new CaseInsensitiveString(theSuperAdmin))), is(true));
        assertThat(goConfigService.isAuthorizedToViewTemplates(new Username(new CaseInsensitiveString("someOtherUserWhoIsNotAdminOfAnyTemplates"))), is(false));
    }
    ...
    public void shouldReturnTrueForSuperAdminToViewTemplateConfiguration() {
        ...
        assertThat(goConfigService.isAuthorizedToViewTemplate(templateName, new Username(new CaseInsensitiveString("admin"))), is(true));
    }
    ...
    public void shouldReturnTrueForTemplateAdminsToViewTemplateConfiguration() {
        ...
        assertThat(goConfigService.isAuthorizedToViewTemplate(templateName, new Username(templateAdmin)), is(true));
    }
    ...
    public void shouldReturnTrueForTemplateViewUsersToViewTemplateConfiguration() {
        ...
        assertThat(goConfigService.isAuthorizedToViewTemplate(templateName, new Username(templateViewUser)), is(true));
    }
    ...
    public void shouldReturnTrueForGroupAdminsToViewTemplateConfigurationByDefault() {
        ...
        assertThat(goConfigService.isAuthorizedToViewTemplate(templateName, new Username(groupAdmin)), is(true));
    }
    ...
    public void shouldReturnFalseForGroupAdminsToViewTemplateConfigurationIfDisallowed() {
        ...
        assertThat(goConfigService.isAuthorizedToViewTemplate(templateName, new Username(groupAdmin)), is(false));
    }
