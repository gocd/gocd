...
describe ApiV4::Admin::Templates::TemplateConfigRepresenter do
  before :each do
  ...
  it 'should render a template with hal representation' do
    actual_json = ApiV4::Admin::Templates::TemplateConfigRepresenter.new(@template).to_hash(url_builder: UrlBuilder.new)
  ...
  it 'should deserialize given json to PipelineTemplateConfig object' do
    ...
    ApiV4::Admin::Templates::TemplateConfigRepresenter.new(deserialized_scm).from_hash(template_hash)
