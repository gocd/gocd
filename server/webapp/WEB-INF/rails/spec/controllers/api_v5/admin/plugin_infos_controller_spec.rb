...
describe ApiV5::Admin::PluginInfosController do
  ...
  describe "index" do
    ...
    it 'should list all plugin_infos' do
      ...
      expect(actual_response).to eq(expected_response([plugin_info], ApiV5::Plugin::PluginInfosRepresenter))
    end
    ...
    it 'should list bad plugins when `include_bad` param is true' do
      ...
      expect(response).to be_ok
      expect(actual_response).to eq(expected_response([good_plugin_info, bad_plugin_info], ApiV5::Plugin::PluginInfosRepresenter))
    end
    ...
    it 'should filter unsupported plugin extensions' do
      ...
      expect(response).to be_ok
      expect(actual_response).to eq(expected_response([notification_plugin_info], ApiV5::Plugin::PluginInfosRepresenter))
    end
    ...
    xdescribe 'route' do
      describe "with_header" do
        it 'should route to the index action of plugin_infos controller' do
          expect(:get => 'api/admin/plugin_info').to route_to(action: 'index', controller: 'api_v5/admin/plugin_infos')
        end
      end
      ...
      describe "without_header" do
        ...
        it 'should not route to index action of plugin_infos controller without header' do
          expect(:get => 'api/admin/plugin_info').to_not route_to(action: 'index', controller: 'api_v5/admin/plugin_infos')
  ...
  describe "show" do
    ...
    it 'should fetch a plugin_info for the given id' do
      ...
      expect(response).to be_ok
      expect(actual_response).to eq(expected_response(plugin_info, ApiV5::Plugin::PluginInfoRepresenter))
    end
    ...
    it 'should fetch a bad plugin info if plugin is bad' do
      ...
      expect(response).to be_ok
      expect(actual_response).to eq(expected_response(bad_plugin_info, ApiV5::Plugin::PluginInfoRepresenter))
    end
    ...
    xdescribe 'route' do
      describe "with_header" do
        ...
        it 'should route to the show action of plugin_infos controller for alphanumeric plugin id' do
          expect(:get => 'api/admin/plugin_info/foo123bar').to route_to(action: 'show', controller: 'api_v5/admin/plugin_infos', id: 'foo123bar')
        end

        it 'should route to the show action of plugin_infos controller for plugin id with hyphen' do
          expect(:get => 'api/admin/plugin_info/foo-123-bar').to route_to(action: 'show', controller: 'api_v5/admin/plugin_infos', id: 'foo-123-bar')
        end

        it 'should route to the show action of plugin_infos controller for plugin id with underscore' do
          expect(:get => 'api/admin/plugin_info/foo_123_bar').to route_to(action: 'show', controller: 'api_v5/admin/plugin_infos', id: 'foo_123_bar')
        end
        ...
        it 'should route to the show action of plugin_infos controller for capitalized plugin id' do
          expect(:get => 'api/admin/plugin_info/FOO').to route_to(action: 'show', controller: 'api_v5/admin/plugin_infos', id: 'FOO')
        end
      end
      ...
      describe "without_header" do
        ...
        it 'should not route to show action of plugin_infos controller without header' do
          expect(:get => 'api/admin/plugin_info/abc').to_not route_to(action: 'show', controller: 'api_v5/admin/plugin_infos')
