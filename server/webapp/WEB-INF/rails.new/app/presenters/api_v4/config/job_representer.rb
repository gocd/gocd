...
module ApiV4
  module Config
    class JobRepresenter < ApiV4::BaseRepresenter
      ...
      collection :environment_variables,
                 exec_context: :decorator,
                 decorator:    ApiV4::Config::EnvironmentVariableRepresenter,
      ...
      collection :tasks,
                 exec_context: :decorator,
                 decorator:    ApiV4::Config::Tasks::TaskRepresenter,
                 expect_hash:  true,
                 class:        lambda { |fragment, *|
                   ApiV4::Config::Tasks::TaskRepresenter.task_class_for_type(fragment[:type]||fragment['type'])
                 }
      collection :tabs,
                 exec_context: :decorator,
      ...
      collection :artifacts,
                 exec_context: :decorator,
                 decorator:    ApiV4::Config::ArtifactRepresenter,
                 expect_hash:  true,
                 class:        lambda { |fragment, *|
                   ApiV4::Config::ArtifactRepresenter.get_class_for_artifact_type(fragment[:type] || fragment['type'])
                 }

      collection :properties, exec_context: :decorator, decorator: ApiV4::Config::PropertyConfigRepresenter, class: com.thoughtworks.go.config.ArtifactPropertiesGenerator, render_empty: false
