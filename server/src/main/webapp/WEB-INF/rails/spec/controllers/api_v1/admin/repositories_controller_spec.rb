  ...
  describe "show" do
    ...
    describe "security" do
      ...
      it 'should disallow anonymous users, with security enabled' do
        enable_security
        login_as_anonymous
        expect(controller).to disallow_action(:get, :show, params: {repo_id: @repo_id}).with(403, 'You are not authorized to perform this action.')
      end
  ...
  describe "destroy" do
    ...
    describe "security" do
      ...
      it 'should disallow anonymous users, with security enabled' do
        enable_security
        login_as_anonymous
        expect(controller).to disallow_action(:delete, :destroy, params: {repo_id: @repo_id}).with(403, 'You are not authorized to perform this action.')
      end
  ...
  describe "update" do
    ...
    describe "security" do
      ...
      it 'should disallow anonymous users, with security enabled' do
        enable_security
        login_as_anonymous
        expect(controller).to disallow_action(:put, :update, params: {repo_id: @repo_id}).with(403, 'You are not authorized to perform this action.')
      end
