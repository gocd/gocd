...
class MaterialModificationsControllerV1Test implements SecurityServiceTrait, ControllerTrait<MaterialModificationsControllerV1> {
  ...
  @Override
  MaterialModificationsControllerV1 createControllerInstance() {
    return new MaterialModificationsControllerV1(new ApiAuthenticationHelper(securityService, goConfigService), materialConfigService,
      materialService)
  }
