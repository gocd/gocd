...
define([
  'mithril', 'string-plus', 'helpers/form_helper', 'helpers/mithril_component_mixins',
  'models/pipeline_configs/pipeline', 'views/pipeline_configs/pipeline_settings_widget',
  'views/pipeline_configs/materials_config_widget', 'views/pipeline_configs/pipeline_flow_widget', 'views/pipeline_configs/errors_widget', 'views/shared/modal'
], function (m, s, f, ComponentMixins, Pipeline, PipelineSettingsWidget, MaterialsConfigWidget, PipelineFlowWidget, ErrorsWidget, Modal) {
      ...
      return (
        <div class='modal-content'>
          ...
          <div class='actions'>
            ...
            <a class='button primary' href={['/go/admin/pipelines/', args.pipeline().name(), '/general'].join('')}>Proceed</a>
          </div>
        </div>
      );
    }
  ...
  var PipelineConfigWidget = function (options) {
    return {
      controller: function () {
        var ctrl              = this;
        var self              = this;
        ...
        Pipeline.find(self.url(), extractEtag).then(function (data) {
