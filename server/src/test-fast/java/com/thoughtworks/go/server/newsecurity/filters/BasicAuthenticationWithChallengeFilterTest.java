...
class BasicAuthenticationWithChallengeFilterTest {
    @Test
    void shouldInvokeHandler() throws IOException {
        ...
        final BasicAuthenticationWithChallengeFilter filter = new BasicAuthenticationWithChallengeFilter(null, handler, null);
