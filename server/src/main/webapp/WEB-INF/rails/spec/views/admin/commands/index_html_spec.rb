...
describe "admin/commands/index.html.erb" do
  ...
  it "should show message about old style args" do
    ...
    expect(response.body).to have_selector("div.gist_based_auto_complete div.error-message-for-old-args a[href='#{docs_url '/advanced_usage/command_repository.html#args-style-commands'}']", :text =>
