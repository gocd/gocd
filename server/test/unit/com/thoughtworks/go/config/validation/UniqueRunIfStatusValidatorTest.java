...
public class UniqueRunIfStatusValidatorTest {
    ...
    public void shouldThrowExceptionWhenThereIsMoreThanOneOnCancelInEachTask() throws Exception {
        try {
            ...
            new MagicalGoConfigXmlLoader(new ConfigCache(), ConfigElementImplementationRegistryMother.withNoPlugins(), metricsProbeService).loadConfigHolder(FileUtil.readToEnd(inputStream));
            fail();
        } catch (Exception e) {
    ...
    public void shouldPassWhenEachJobContainsOnCancel() throws Exception {
        ...
        CruiseConfig cruiseConfig = new MagicalGoConfigXmlLoader(new ConfigCache(), ConfigElementImplementationRegistryMother.withNoPlugins(), metricsProbeService).loadConfigHolder(FileUtil.readToEnd(inputStream)).config;
