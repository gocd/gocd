 ...
 */
package com.thoughtworks.go.apiv12.admin.pipelineconfig;
...
@Component
public class PipelineConfigControllerV12 extends ApiController implements SparkSpringController, CrudController<PipelineConfig> {
