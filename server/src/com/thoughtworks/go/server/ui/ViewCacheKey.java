...
public class ViewCacheKey {
    ...
    private String keyForPipelineModelFragment(PipelineModel model, String name) {
        ...
        s.append(name);
        s.append(model.getDisplayName());//FIXME: use the delimiter, the two values appended at this point can combine to get something completely different (ALWAYS USE DELIMITER.)!!! - Sara & JJ
