...
public class SpaControllers implements SparkSpringController {
    ...
    public SpaControllers(SPAAuthenticationHelper authenticationHelper,
        ...
        sparkControllers.add(new NewPreferencesController(authenticationHelper, templateEngineFactory.create(NewPreferencesController.class, () -> COMPONENT_LAYOUT_PATH)));
        ...
        sparkControllers.add(new AdminTemplatesController(authenticationHelper, templateEngineFactory.create(AdminTemplatesController.class, () -> COMPONENT_LAYOUT_PATH),featureToggleService));
