...
Gem::Specification.new do |s|
  ...
  s.authors = ["Rajan Agaskar".freeze, "Christian Williams".freeze, "Davis Frank".freeze]
  s.date = "2015-04-28"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<jasmine-core>.freeze, ["~> 2.3"])
      ...
      s.add_dependency(%q<jasmine-core>.freeze, ["~> 2.3"])
