...
public class PipelineSelectionsTest {
    ...
    public void etagBasedOnFilterContent() {
        ...
        assertEquals("148c3fde87ad2ac597262975fece58e64036a79ced54351a700232ac6fda90b0", ps.getEtag());

        ps.update(Filters.defaults(), null, null);
        assertEquals("2356e5d4241f22987d8f8cb8920913fda237385b423bd7eec7e97b2a9eb1be1a", ps.getEtag());

        ps.update(Filters.single(new WhitelistFilter(DEFAULT_NAME, CaseInsensitiveString.list("p1"), new HashSet<>())), null, null);
        assertEquals("9ffa0b91a0100dac243e4a4f47303057b888e1e0b25cdb26aaf05c019f8e71ee", ps.getEtag());

        ps.setFilters(format("{\"filters\": [{\"name\": \"%s\", \"type\": \"blacklist\", \"state\": [], \"pipelines\": [\"foobar\"]}]}", DEFAULT_NAME));
        assertEquals("224c1949538a5a278c061a99c40797bf3849d13fca7f3aeb249171851f2a384e", ps.getEtag());
    }
}
