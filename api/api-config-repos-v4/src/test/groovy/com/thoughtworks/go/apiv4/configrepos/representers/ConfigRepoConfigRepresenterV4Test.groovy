...
class ConfigRepoConfigRepresenterV4Test {
  ...
  class toJson {
    @Test
    void toJSON() {
      String json = toObjectString({ w -> ConfigRepoConfigRepresenterV4.toJSON(w, repo(ID)) })
    ...
    void "toJSON should serialize errors"() {
      ...
      String json = toObjectString({ w ->
        ConfigRepoConfigRepresenterV4.toJSON(w, configRepo)
      })
    ...
    void 'should serialize with rules'() {
      ...
      def actualJson = toObjectString({ ConfigRepoConfigRepresenterV4.toJSON(it, configRepoConfig) })
  ...
  class fromJson {
    ...
    void fromJSON() {
      ...
      ConfigRepoConfig actual = ConfigRepoConfigRepresenterV4.fromJSON(json)
