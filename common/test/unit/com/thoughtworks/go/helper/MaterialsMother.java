...
public class MaterialsMother {
    ...
    private static MaterialConfigConverter materialConfigConverter = new MaterialConfigConverter();
    ...
    public static Material createMaterialFromMaterialConfig(MaterialConfig materialConfig) {
        return materialConfigConverter.toMaterial(materialConfig);
    }

    public static Materials createMaterialsFromMaterialConfigs(MaterialConfigs materialConfigs) {
        return materialConfigConverter.toMaterials(materialConfigs);
    }
}
