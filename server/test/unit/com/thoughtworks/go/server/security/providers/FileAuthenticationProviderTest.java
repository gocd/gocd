...
public class FileAuthenticationProviderTest {
    ...
    public void shouldThrowExceptionIfFileDoesNotExist() throws Exception {
        when(goConfigService.security()).thenReturn(new SecurityConfig(new PasswordFileConfig("ueyrweiyri"), null));
    ...
    private void setupFile(String userAndPasswordAndRoles) throws IOException {
        ...
        final SecurityConfig securityConfig = new SecurityConfig(
                new PasswordFileConfig(passwordFile.getAbsolutePath()), null);
