  ...
  describe "show" do
    ...
    describe "security" do
      ...
      it 'should disallow anonymous users, with security enabled' do
        enable_security
        login_as_anonymous
        expect(controller).to disallow_action(:get, :show, params: {name: @environment_name}).with(403, 'You are not authorized to perform this action.')
      end
  ...
  describe "put" do
    ...
    describe "security" do
      ...
      it 'should disallow anonymous users, with security enabled' do
        enable_security
        login_as_anonymous
        expect(controller).to disallow_action(:put, :put, params: {name: @environment_name}).with(403, 'You are not authorized to perform this action.')
      end
  ...
  describe "patch" do
    ...
    describe "security" do
      ...
      it 'should disallow anonymous users, with security enabled' do
        enable_security
        login_as_anonymous
        expect(controller).to disallow_action(:patch, :patch, params: {name: @environment_name}).with(403, 'You are not authorized to perform this action.')
      end
  ...
  describe "destroy" do
    ...
    describe "security" do
      ...
      it 'should disallow anonymous users, with security enabled' do
        enable_security
        login_as_anonymous
        expect(controller).to disallow_action(:delete, :destroy, params: {name: @environment_name}).with(403, 'You are not authorized to perform this action.')
      end
