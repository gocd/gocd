...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<guard-coffeescript>.freeze, [">= 0"])
      s.add_development_dependency(%q<appraisal>.freeze, [">= 0.5.2"])
      s.add_development_dependency(%q<byebug>.freeze, [">= 0"])
      s.add_development_dependency(%q<therubyracer>.freeze, [">= 0.12.1"])
    else
      ...
      s.add_dependency(%q<guard-coffeescript>.freeze, [">= 0"])
