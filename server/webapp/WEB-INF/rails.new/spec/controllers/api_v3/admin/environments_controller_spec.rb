...
describe ApiV3::Admin::EnvironmentsController do
    ...
    describe :route do
      describe :with_header do
        it 'should route to index action of environments controller' do
          expect(:get => 'api/admin/environments').to route_to(action: 'index', controller: 'api_v3/admin/environments')
        end
      end
      describe :without_header do
        ...
        it 'should not route to index action of environments controller without header' do
          expect(:get => 'api/admin/environments').to_not route_to(action: 'index', controller: 'api_v3/admin/environments')
    ...
    describe :route do
      describe :with_header do
        it 'should route to show action of environments controller for alphanumeric environment name' do
          expect(:get => 'api/admin/environments/foo123').to route_to(action: 'show', controller: 'api_v3/admin/environments', name: 'foo123')
        end

        it 'should route to show action of environments controller for environment name with dots' do
          expect(:get => 'api/admin/environments/foo.123').to route_to(action: 'show', controller: 'api_v3/admin/environments', name: 'foo.123')
        end
        ...
        it 'should route to show action of environments controller for environment name with underscore' do
          expect(:get => 'api/admin/environments/foo_123').to route_to(action: 'show', controller: 'api_v3/admin/environments', name: 'foo_123')
        end

        it 'should route to show action of environments controller for capitalized environment name' do
          expect(:get => 'api/admin/environments/FOO').to route_to(action: 'show', controller: 'api_v3/admin/environments', name: 'FOO')
        end
      end
      describe :without_header do
        before :each do
        ...
        it 'should not route to show action of environments controller without header' do
          expect(:get => 'api/admin/environments/foo').to_not route_to(action: 'show', controller: 'api_v3/admin/environments')
    ...
    describe :route do
      describe :with_header do
        it 'should route to put action of environments controller for alphanumeric environment name' do
          expect(:put => 'api/admin/environments/foo123').to route_to(action: 'put', controller: 'api_v3/admin/environments', name: 'foo123')
        end

        it 'should route to put action of environments controller for environment name with dots' do
          expect(:put => 'api/admin/environments/foo.123').to route_to(action: 'put', controller: 'api_v3/admin/environments', name: 'foo.123')
        end
        ...
        it 'should route to put action of environments controller for environment name with underscore' do
          expect(:put => 'api/admin/environments/foo_123').to route_to(action: 'put', controller: 'api_v3/admin/environments', name: 'foo_123')
        end

        it 'should route to put action of environments controller for capitalized environment name' do
          expect(:put => 'api/admin/environments/FOO').to route_to(action: 'put', controller: 'api_v3/admin/environments', name: 'FOO')
        end
      end
      describe :without_header do
        before :each do
        ...
        it 'should not route to put action of environments controller without header' do
          expect(:put => 'api/admin/environments/foo').to_not route_to(action: 'put', controller: 'api_v3/admin/environments')
    ...
    describe :route do
      describe :with_header do
        it 'should route to patch action of environments controller for alphanumeric environment name' do
          expect(:patch => 'api/admin/environments/foo123').to route_to(action: 'patch', controller: 'api_v3/admin/environments', name: 'foo123')
        end

        it 'should route to patch action of environments controller for environment name with dots' do
          expect(:patch => 'api/admin/environments/foo.123').to route_to(action: 'patch', controller: 'api_v3/admin/environments', name: 'foo.123')
        end
        ...
        it 'should route to patch action of environments controller for environment name with underscore' do
          expect(:patch => 'api/admin/environments/foo_123').to route_to(action: 'patch', controller: 'api_v3/admin/environments', name: 'foo_123')
        end

        it 'should route to patch action of environments controller for capitalized environment name' do
          expect(:patch => 'api/admin/environments/FOO').to route_to(action: 'patch', controller: 'api_v3/admin/environments', name: 'FOO')
        end
      end
      describe :without_header do
        before :each do
        ...
        it 'should not route to put action of environments controller without header' do
          expect(:patch => 'api/admin/environments/foo').to_not route_to(action: 'put', controller: 'api_v3/admin/environments')
    ...
    describe :route do
      describe :with_header do
        it 'should route to destroy action of environments controller for alphanumeric environment name' do
          expect(:delete => 'api/admin/environments/foo123').to route_to(action: 'destroy', controller: 'api_v3/admin/environments', name: 'foo123')
        end

        it 'should route to destroy action of environments controller for environment name with dots' do
          expect(:delete => 'api/admin/environments/foo.123').to route_to(action: 'destroy', controller: 'api_v3/admin/environments', name: 'foo.123')
        end
        ...
        it 'should route to destroy action of environments controller for environment name with underscore' do
          expect(:delete => 'api/admin/environments/foo_123').to route_to(action: 'destroy', controller: 'api_v3/admin/environments', name: 'foo_123')
        end

        it 'should route to destroy action of environments controller for capitalized environment name' do
          expect(:delete => 'api/admin/environments/FOO').to route_to(action: 'destroy', controller: 'api_v3/admin/environments', name: 'FOO')
        end
      end
      describe :without_header do
        before :each do
        ...
        it 'should not route to destroy action of environments controller without header' do
          expect(:delete => 'api/admin/environments/foo').to_not route_to(action: 'destroy', controller: 'api_v3/admin/environments')
    ...
    describe :route do
      describe :with_header do
        it 'should route to create action of environments controller' do
          expect(:post => 'api/admin/environments/').to route_to(action: 'create', controller: 'api_v3/admin/environments')
        end
      end
      describe :without_header do
        before :each do
        ...
        it 'should not route to create action of environments controller without header' do
          expect(:post => 'api/admin/environments').to_not route_to(action: 'create', controller: 'api_v3/admin/environments')
