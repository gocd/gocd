...
module ApiV2
  class AgentsController < ApiV2::BaseController
    ...
    def set_default_values_if_not_present
      params[:uuids] = params[:uuids] || Array.new
      ...
      params[:operations][:resources][:add] = params[:operations][:resources][:add] || Array.new
      params[:operations][:resources][:remove] = params[:operations][:resources][:remove] || Array.new
      params[:operations][:environments][:add] = params[:operations][:environments][:add] || Array.new
      params[:operations][:environments][:remove] = params[:operations][:environments][:remove] || Array.new
    end
