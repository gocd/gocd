...
describe ApiV3::Config::TimerRepresenter do
  ...
  it "should deserialize" do
    presenter           = ApiV3::Config::TimerRepresenter.new(com.thoughtworks.go.config.TimerConfig.new)
