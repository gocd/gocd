...
import com.thoughtworks.go.plugin.access.elastic.v3.AgentMetadataConverterV3;
import com.thoughtworks.go.plugin.access.elastic.v3.AgentMetadataDTO;
...
public class ElasticAgentProcessorConverterV3 implements ElasticAgentProcessorConverter {
    private static final Gson GSON = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();
    private static final AgentMetadataConverterV3 agentMetadataConverter = new AgentMetadataConverterV3();
