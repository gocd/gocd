...
@Component
public class PluginImagesController implements SparkSpringController {

    private final PluginImagesControllerDelegate delegate;

    @Autowired
    public PluginImagesController(DefaultPluginInfoFinder pluginInfoFinder) {
        this.delegate = new PluginImagesControllerDelegate(pluginInfoFinder);
    }
