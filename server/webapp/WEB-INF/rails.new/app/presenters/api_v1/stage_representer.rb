      ...
      [
        {
          ...
          href:         opts[:url_builder].stage_instance_by_counter_api_url(url_params)
        },
        {
          content_type: CONTENT_TYPE_HTML,
          href:         opts[:url_builder].stage_detail_tab_url(url_params)
        }
      ]
    end

    link :doc do
      'http://www.go.cd/documentation/user/current/api/v1/stages_api.html'
    end
