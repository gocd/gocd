...
define(["jquery", "mithril", "views/template_configs/pipeline_selection_widget",
    "models/template_configs/template"],
  function ($, m, PipelineSelectionWidget, Template) {
    ...
    describe("PipelineSelectionWidget", function () {
      ...
      describe('Pipeline List', function () {
        beforeEach(function () {
          ...
          m.mount(root, m.component(PipelineSelectionWidget, { template: m.prop(Template.fromJSON({})) }));
          m.redraw(true);
        });
