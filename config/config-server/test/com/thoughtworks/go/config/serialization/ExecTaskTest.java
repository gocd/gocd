...
public class ExecTaskTest {
    private MetricsProbeService metricsProbeService = mock(MetricsProbeService.class);
    @Test
    public void shouldSupportMultipleArgs() throws Exception {
        String xml = "<exec command='ls'>\n"
                ...
                + "  <arg>arg2</arg>\n"
                + "</exec>";
        ExecTask execTask = new MagicalGoConfigXmlLoader(new ConfigCache(), ConfigElementImplementationRegistryMother.withNoPlugins(), metricsProbeService).fromXmlPartial(xml, ExecTask.class);
    ...
    public void shouldNotSupportArgsAttributeWithArgSubElement() throws Exception {
        ...
        try {
            ...
            new MagicalGoConfigXmlLoader(new ConfigCache(), registry, metricsProbeService).loadConfigHolder(FileUtil.readToEnd(IOUtils.toInputStream(configXml)));
