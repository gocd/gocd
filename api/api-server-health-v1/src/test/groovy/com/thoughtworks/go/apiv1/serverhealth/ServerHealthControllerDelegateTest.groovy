...
class ServerHealthControllerDelegateTest implements ControllerTrait<ServerHealthControllerDelegate>, SecurityServiceTrait {
  ...
  @Override
  ServerHealthControllerDelegate createControllerInstance() {
    return new ServerHealthControllerDelegate()
  }
