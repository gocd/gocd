...
@Component
public class TemplateConfigControllerV4 extends ApiController implements SparkSpringController, CrudController<PipelineTemplateConfig> {
    ...
    @Autowired
    public TemplateConfigControllerV4(TemplateConfigService templateConfigService, ApiAuthenticationHelper apiAuthenticationHelper, EntityHashingService entityHashingService) {
        super(ApiVersion.v4);
