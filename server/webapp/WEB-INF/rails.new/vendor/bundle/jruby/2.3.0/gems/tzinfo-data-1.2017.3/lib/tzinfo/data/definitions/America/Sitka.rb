      ...
      module America
        module Sitka
          ...
          timezone 'America/Sitka' do |tz|
            ...
            tz.transition 2066, 3, :o8, 3035790000, 59417375, 24
            tz.transition 2066, 11, :o7, 3056349600, 29711543, 12
            tz.transition 2067, 3, :o8, 3067239600, 59426111, 24
            tz.transition 2067, 11, :o7, 3087799200, 29715911, 12
          end
        end
      end
    end
