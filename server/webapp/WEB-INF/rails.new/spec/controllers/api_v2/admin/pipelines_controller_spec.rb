  ...
  describe 'security' do
    describe 'show' do
      ...
      it 'should allow anyone, with security disabled' do
        disable_security
        expect(controller).to allow_action(:get, :show, pipeline_name: "pipeline1")
      end
    ...
    describe 'update' do
      it 'should allow anyone, with security disabled' do
        ...
        expect(controller).to allow_action(:put, :update, pipeline_name: "pipeline1")
      end
    ...
    describe 'destroy' do
      ...
      it 'should allow anyone, with security disabled' do
        disable_security
        expect(controller).to allow_action(:delete, :destroy, pipeline_name: "pipeline1")
      end
  ...
  describe 'action' do
      ...
      describe 'route' do
        describe 'with_header' do
          ...
          it 'should route to show action of pipelines controller for pipeline name with dots' do
            expect(:get => 'api/admin/pipelines/foo.123').to route_to(action: 'show', controller: 'api_v2/admin/pipelines', pipeline_name: 'foo.123')
          end
          ...
          it 'should route to show action of pipelines controller for pipeline name with underscore' do
            expect(:get => 'api/admin/pipelines/foo_123').to route_to(action: 'show', controller: 'api_v2/admin/pipelines', pipeline_name: 'foo_123')
          end

          it 'should route to show action of pipelines controller for capitalized pipeline name' do
            expect(:get => 'api/admin/pipelines/FOO').to route_to(action: 'show', controller: 'api_v2/admin/pipelines', pipeline_name: 'FOO')
          end
        end
      ...
      describe 'route' do
        describe 'with_header' do
          ...
          it 'should route to update action of pipelines controller for pipeline name with dots' do
            expect(:put => 'api/admin/pipelines/foo.123').to route_to(action: 'update', controller: 'api_v2/admin/pipelines', pipeline_name: 'foo.123')
          end
          ...
          it 'should route to update action of pipelines controller for pipeline name with underscore' do
            expect(:put => 'api/admin/pipelines/foo_123').to route_to(action: 'update', controller: 'api_v2/admin/pipelines', pipeline_name: 'foo_123')
          end

          it 'should route to update action of pipelines controller for capitalized pipeline name' do
            expect(:put => 'api/admin/pipelines/FOO').to route_to(action: 'update', controller: 'api_v2/admin/pipelines', pipeline_name: 'FOO')
          end
        end
        describe 'without_header' do
          before :each do
    ...
    describe 'create' do
      ...
      it "should not allow admin users of one pipeline group to create a new pipeline config in another group" do
        login_as_pipeline_group_admin_user('one-group')
      ...
      it "should allow admin users create a new pipeline config in any group" do
        ...
        expect(@pipeline_config_service).to receive(:getPipelineConfig).with(@pipeline_name).and_return(nil, @pipeline)
      ...
      describe 'route' do
        describe 'with_header' do
          ...
          it 'should route to destroy action of pipelines controller for pipeline name with dots' do
            expect(:delete => 'api/admin/pipelines/foo.123').to route_to(action: 'destroy', controller: 'api_v2/admin/pipelines', pipeline_name: 'foo.123')
          end
          ...
          it 'should route to destroy action of pipelines controller for pipeline name with underscore' do
            expect(:delete => 'api/admin/pipelines/foo_123').to route_to(action: 'destroy', controller: 'api_v2/admin/pipelines', pipeline_name: 'foo_123')
          end

          it 'should route to destroy action of pipelines controller for capitalized pipeline name' do
            expect(:delete => 'api/admin/pipelines/FOO').to route_to(action: 'destroy', controller: 'api_v2/admin/pipelines', pipeline_name: 'FOO')
          end
        end
        describe 'without_header' do
          before :each do
