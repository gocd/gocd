...
public class MergeCruiseConfigTest {
    public GoConfigMother goConfigMother;
    private BasicPipelineConfigs pipelines;
    private BasicCruiseConfig mainCruiseConfig;
    private MergeCruiseConfig cruiseConfig;
    ...
    public void shouldReturnAMapOfTemplateNamesToListOfAssociatedPipelinesCaseInsensitively() {
        ...
        CruiseConfig cruiseConfig = new MergeCruiseConfig(new BasicCruiseConfig(new BasicPipelineConfigs(pipelineConfig1, pipelineConfig2, pipelineConfigWithoutTemplate)));
    ...
    public void shouldReturnTrueForPipelineThatInFirstGroup() {
        PipelineConfigs group1 = createGroup("group1", createPipelineConfig("pipeline1", "stage1"));
        CruiseConfig config = new MergeCruiseConfig(new BasicCruiseConfig(group1));
    ...
    public void shouldReturnTrueIfThereAreTwoPipelineGroups() throws Exception {
        CruiseConfig config = new MergeCruiseConfig(goConfigMother.cruiseConfigWithTwoPipelineGroups());
    ...
    public void shouldReturnFalseIfThereIsOnePipelineGroup() throws Exception {
        CruiseConfig config = new MergeCruiseConfig(goConfigMother.cruiseConfigWithOnePipelineGroup());
    ...
    public void shouldFindDownstreamPipelines() throws Exception {
        CruiseConfig config = new MergeCruiseConfig(goConfigMother.defaultCruiseConfig());
    ...
    public void shouldReturnFalseIfNoMailHost() throws Exception {
        assertThat(new MergeCruiseConfig(new BasicCruiseConfig()).isMailHostConfigured(), is(false));
    }
    ...
    public void shouldReturnTrueIfMailHostIsConfigured() throws Exception {
        ...
        assertThat(new MergeCruiseConfig(GoConfigMother.cruiseConfigWithMailHost(mailHost)).isMailHostConfigured(), is(true));
    }

    @Test
    public void shouldNotLockAPipelineWhenItIsAddedToAnEnvironment() throws Exception {
        CruiseConfig config = new MergeCruiseConfig(GoConfigMother.configWithPipelines("pipeline-1"));
    ...
    public void getAllErrors_shouldIgnoreErrorsOnElementToBeSkipped() {
        CruiseConfig config = new MergeCruiseConfig(
          GoConfigMother.configWithPipelines("pipeline-1"));
    ...
    public void shouldErrorOutWhenDependsOnItself() throws Exception {
        CruiseConfig cruiseConfig = new MergeCruiseConfig(new BasicCruiseConfig());
    ...
    public void shouldReturnDefaultGroupNameIfNoGroupNameIsSpecified() {
        CruiseConfig cfg = new MergeCruiseConfig(new BasicCruiseConfig());
