...
describe AgentJobRunHistoryAPIModel do
  ...
  describe "should initialize correctly" do
    it "should populate correct data" do
      ...
      expect(agent_job_run_history_api_model.pagination.page_size).to eq(10)
      expect(agent_job_run_history_api_model.pagination.offset).to eq(1)
      expect(agent_job_run_history_api_model.pagination.total).to eq(100)
    ...
    it "should handle empty data" do
      ...
      expect(agent_job_run_history_api_model.pagination.page_size).to eq(nil)
      expect(agent_job_run_history_api_model.pagination.offset).to eq(nil)
      expect(agent_job_run_history_api_model.pagination.total).to eq(nil)
