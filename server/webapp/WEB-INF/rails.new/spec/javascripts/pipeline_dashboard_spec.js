...
describe("pipeline_dashboard", function () {
    beforeEach(function () {
        setFixtures("<div class='under_test'>\n" +
            ...
            "                                    <form action='/api/pipelines/pipeline-1/schedule' method='post'\n" +
            ...
            "                                        </div>\n" +
            "                                    </form>\n" +
            "                                    <form action='/pipelines/show_for_trigger' method='post'\n" +
            ...
            "                                </div>\n" +
            "                                <div class='pipeline_operations'>\n" +
            "                                    <form action='/api/pipelines/pipeline-2/schedule' method='post'\n" +
            ...
            "                                </div>\n" +
            "                                <div class='pipeline_operations'>\n" +
            "                                    <form action='/api/pipelines/pipeline-3/schedule' method='post'\n" +
            ...
            "                                </div>\n" +
            "                                <div class='pipeline_operations'>\n" +
            "                                    <form action='/api/pipelines/pipeline-4/schedule' method='post'\n" +
            ...
            "                                </div>\n" +
            "                                <div class='pipeline_operations'>\n" +
            "                                    <form action='/api/pipelines/pipeline-2-1/schedule' method='post'\n" +
