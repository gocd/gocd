...
describe ApiV5::Plugin::ElasticPluginCapabilitiesRepresenter do
  it 'should describe elastic agent capabilities' do
    ...
    actual_json = ApiV5::Plugin::ElasticPluginCapabilitiesRepresenter.new(capabilities).to_hash(url_builder: UrlBuilder.new)
