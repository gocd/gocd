...
public class FullConfigSaveNormalFlowIntegrationTest {
    @Autowired
    ...
    public void shouldEncryptPluginPropertiesOfPublishTask() throws Exception {
        ...
        GoConfigHolder configHolder = fullConfigSaveNormalFlow.execute(new FullConfigUpdateCommand(cruiseConfig, null), new ArrayList<>(), "Upgrade");
