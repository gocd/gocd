...
class PipelineGroupsControllerV1DelegateTest implements SecurityServiceTrait, ControllerTrait<PipelineGroupsControllerV1Delegate> {
  ...
  @Override
  PipelineGroupsControllerV1Delegate createControllerInstance() {
    return new PipelineGroupsControllerV1Delegate(pipelineConfigsService, new ApiAuthenticationHelper(securityService, goConfigService), entityHashingService, securityService)
  }
