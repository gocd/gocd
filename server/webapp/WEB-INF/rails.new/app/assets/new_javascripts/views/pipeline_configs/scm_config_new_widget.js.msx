...
define(['mithril', 'helpers/form_helper', 'views/pipeline_configs/scm_config_angular_widget', 'models/pipeline_configs/scms', 'views/pipeline_configs/errors_widget'],
  function (m, f, SCMConfigAngularWidget, SCMs, ErrorsWidget) {
