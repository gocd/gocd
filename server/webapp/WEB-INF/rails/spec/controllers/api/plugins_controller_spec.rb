...
describe Api::PluginsController do
  ...
  it "should answer to /api/plugins/status" do
    params_from(:get, "/api/plugins/status").should == {:action => "status", :controller => 'api/plugins', :no_layout => true}
  end
