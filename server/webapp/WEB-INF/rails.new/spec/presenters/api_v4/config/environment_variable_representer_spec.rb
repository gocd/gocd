...
describe ApiV4::Config::EnvironmentVariableRepresenter do
  it 'should render plain environment variable with hal representation' do
    presenter   = ApiV4::Config::EnvironmentVariableRepresenter.new(get_plain_variable)
  ...
  it 'should render secure environment variable with hal representation' do
    presenter   = ApiV4::Config::EnvironmentVariableRepresenter.new(get_secure_variable)
    actual_json = presenter.to_hash(url_builder: UrlBuilder.new)
  ...
  it 'should convert from secure hash with encrypted value to EnvironmentVariableConfig' do
    ...
    presenter = ApiV4::Config::EnvironmentVariableRepresenter.new(config)
