...
public class AgentStatusReportingIntegrationTest {
    ...
    public void before() {
        ...
        this.agentRuntimeInfo = AgentRuntimeInfo.fromAgent(agentIdentifier, "cookie", null);
    }
    ...
    private AgentRuntimeInfo expectedAgentRuntimeInfo() {
        AgentRuntimeInfo info = AgentRuntimeInfo.fromAgent(agentIdentifier, "cookie", null);
