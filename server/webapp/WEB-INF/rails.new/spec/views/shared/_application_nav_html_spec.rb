...
describe "/shared/_application_nav.html.erb" do
  ...
  describe "user name and logout" do
    ...
    it "should display username and logout botton if a user is logged in" do
      ...
      expect(response.body).to have_selector(".user .help a[href='https://gocd.io/help']", text: "Help")
  ...
  describe :admin_dropdown do
    ...
    it "should show only tabs relevant to group admin in admin dropdown if user is just group admin" do
      ...
      assert_values_there = {"Pipelines" => pipeline_groups_path, "Templates" => templates_path, "Config XML" => pipelines_snippet_path, "Plugins" => plugins_listing_path, "Package Repositories" => package_repositories_new_path, "Elastic Agent Profiles" => admin_elastic_profiles_path}
