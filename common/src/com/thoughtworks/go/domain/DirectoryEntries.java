...
public class DirectoryEntries extends ArrayList<DirectoryEntry> implements HtmlRenderable, JsonAware {
    ...
    public void render(HtmlRenderer renderer) {
        if (isArtifactsDeleted || isEmpty()) {
            HtmlElement element = p().content("Artifacts for this job instance are unavailable as they may have been <a href='https://www.gocd.io/documentation/user/current/configuration/delete_artifacts.html' target='blank'>purged by Go</a> or deleted externally. "
