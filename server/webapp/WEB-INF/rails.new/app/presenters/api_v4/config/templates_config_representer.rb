...
module ApiV4
  module Config
    class TemplatesConfigRepresenter < ApiV4::BaseRepresenter
      ...
      collection :templates, embedded: true, decorator: ApiV4::Config::TemplateSummaryRepresenter, exec_context: :decorator
