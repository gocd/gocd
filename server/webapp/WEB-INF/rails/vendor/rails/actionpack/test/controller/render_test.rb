...
class TestController < ActionController::Base
  ...
  def layout_test_with_different_layout
    render :action => "agents", :layout => "standard"
  end

  def layout_test_with_different_layout_and_string_action
    render "agents", :layout => "standard"
  end
  ...
  def rendering_without_layout
    render :action => "agents", :layout => false
  end
  ...
  private
    def determine_layout
      case action_name
        when "agents", "layout_test", "rendering_without_layout",
...
class EtagRenderTest < ActionController::TestCase
  ...
  def test_etag_should_not_be_changed_when_already_set
    ...
    assert_equal etag_for("agents"), @response.headers['ETag']
  end
...
class RenderingLoggingTest < ActionController::TestCase
  ...
  def test_logger_prints_layout_and_template_rendering_info
    ...
    assert_equal "Rendering test/agents", logged[1]
  end
end
