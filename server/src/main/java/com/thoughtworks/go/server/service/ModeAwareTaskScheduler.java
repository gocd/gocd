...
class ModeAwareTaskScheduler implements TaskScheduler {

    private final TaskScheduler scheduler;
    private final SystemEnvironment systemEnvironment;

    private Runnable wrap(Runnable runnable) {
        return new ModeAwareRunnable(runnable, systemEnvironment);
    }

    ModeAwareTaskScheduler(TaskScheduler scheduler, SystemEnvironment systemEnvironment) {
