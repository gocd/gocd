...
public class PipelineSchedulerTest {
    ...
    public void shouldReturn404WhenVariableIsNotInConfigScope() {
        ...
        verify(buildCauseProducerService, new NoMoreInteractions()).manualSchedulePipeline(any(Username.class), any(String.class), any(ScheduleOptions.class), any(OperationResult.class));
    ...
    public void shouldSchedulePipelineWithEnvironmentVariableOverrides() {
        ...
        //noinspection unchecked
        verify(buildCauseProducerService).manualSchedulePipeline(Username.ANONYMOUS, CaseInsensitiveString.str(pipelineConfig.name()), new ScheduleOptions(new HashMap<String, String>(), variables, new HashMap<String, String>()),
                operationResult);
    }
