...
describe ApiV2::Config::PipelineConfigSummaryRepresenter do

  it 'renders pipeline summary' do
    presenter = ApiV2::Config::PipelineConfigSummaryRepresenter.new(com.thoughtworks.go.config.EnvironmentPipelineConfig.new('pipeline1'))
    ...
    expect(actual_json).to have_link(:doc).with_url(com.thoughtworks.go.CurrentGoCDVersion.apiDocsUrl '#pipeline-config')
