...
public class PipelineGroupsControllerV1Delegate extends ApiController implements CrudController<PipelineConfigs> {
  ...
  public PipelineGroupsControllerV1Delegate(PipelineConfigsService pipelineConfigsService, ApiAuthenticationHelper apiAuthenticationHelper, EntityHashingService entityHashingService, SecurityService securityService) {
    super(ApiVersion.v1);
