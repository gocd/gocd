...
module ApiV2
  module AuthenticationHelper
    ...
    def render_not_found_error
      render ApiV2::BaseController::DEFAULT_FORMAT => { :message => 'Either the resource you requested was not found, or you are not authorized to perform this action.' }, :status => 404
    end

    def render_bad_request(exception)
      render ApiV2::BaseController::DEFAULT_FORMAT => { :message => "Your request could not be processed. #{exception.message}" }, :status => 400
    end
