 ...
 */
package com.thoughtworks.go.apiv8.admin.templateconfig

import com.thoughtworks.go.api.SecurityTestTrait
import com.thoughtworks.go.api.spring.ApiAuthenticationHelper
import com.thoughtworks.go.apiv8.admin.templateconfig.representers.ParametersRepresenter
import com.thoughtworks.go.apiv8.admin.templateconfig.representers.TemplateConfigRepresenter
import com.thoughtworks.go.apiv8.admin.templateconfig.representers.TemplatesConfigRepresenter
...
class TemplateConfigControllerV8Test implements SecurityServiceTrait, ControllerTrait<TemplateConfigControllerV8> {
  ...
  @Override
  TemplateConfigControllerV8 createControllerInstance() {
    return new TemplateConfigControllerV8(templateConfigService, new ApiAuthenticationHelper(securityService, goConfigService), entityHashingService)
  }
