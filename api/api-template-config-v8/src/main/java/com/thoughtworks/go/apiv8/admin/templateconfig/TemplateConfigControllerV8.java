...
@Component
public class TemplateConfigControllerV8 extends ApiController implements SparkSpringController, CrudController<PipelineTemplateConfig> {
    ...
    @Autowired
    public TemplateConfigControllerV8(TemplateConfigService templateConfigService, ApiAuthenticationHelper apiAuthenticationHelper, EntityHashingService entityHashingService) {
        super(ApiVersion.v8);
