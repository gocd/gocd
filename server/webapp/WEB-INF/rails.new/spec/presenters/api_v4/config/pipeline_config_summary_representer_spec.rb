...
describe ApiV4::Config::PipelineConfigSummaryRepresenter do

  it 'renders pipeline summary' do
    presenter = ApiV4::Config::PipelineConfigSummaryRepresenter.new(com.thoughtworks.go.config.EnvironmentPipelineConfig.new('pipeline1'))
