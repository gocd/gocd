...
import com.thoughtworks.go.plugin.access.configrepo.contract.CRBuiltInArtifact;
import com.thoughtworks.go.plugin.access.configrepo.contract.CRPluggableArtifact;

import java.lang.reflect.Type;

public class ArtifactTypeAdapter extends TypeAdapter implements JsonDeserializer<com.thoughtworks.go.plugin.access.configrepo.contract.CRArtifact>, JsonSerializer<com.thoughtworks.go.plugin.access.configrepo.contract.CRArtifact> {
