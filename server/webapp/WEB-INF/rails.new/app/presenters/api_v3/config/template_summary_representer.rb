...
module ApiV3
  module Config
    class TemplateSummaryRepresenter < ApiV3::BaseRepresenter
      ...
      collection :pipelines, embedded: true, exec_context: :decorator, decorator: ApiV3::Config::PipelineConfigSummaryRepresenter
