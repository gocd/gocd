...
define "cruise" do |project|
  ...
  define "agent-bootstrapper", :layout => agent_bootstrapper_layout("agent-bootstrapper") do
  ...
  define "server", :layout => server_layout("server") do
...
END
  ...
  define "misc", :layout => submodule_layout_for_different_src("server") do
  ...
  define 'pkg', :layout => submodule_layout('pkg') do
