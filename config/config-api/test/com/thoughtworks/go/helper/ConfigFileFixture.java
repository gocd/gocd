...
public final class ConfigFileFixture {
    ...
    public static final String WITH_RAKE_TASK_CONFIG =
                "<cruise schemaVersion='75'>\n"
                    + "<pipelines>\n"
                    + "<pipeline name='pipeline1'>\n"
                    + "    <materials>\n"
                    + "      <svn url =\"svnurl\"/>"
                    ...
                    + "        </ant>\n"
                    + "        <rake />\n"
                    + "        <rake buildfile=\"build-file-1\" target=\"target-1\" workingdir=\"working-directory-1\">\n"
                    + "         <runif status='failed' />\n"
                    + "         <oncancel>\n"
                    + "          <exec command='ls' />\n"
                    + "         </oncancel>\n"
                    ...
                    + "         <runif status='failed' />\n"
                    + "         <oncancel>\n"
                    + "          <rake buildfile=\"cancel-build-file-1\" target=\"cancel-target-1\" workingdir=\"cancel-working-directory-1\" />\n"
                    + "         </oncancel>\n"
                    + "        </exec>\n"
                    + "        <rake buildfile=\"build-file-2\">\n"
                    + "         <runif status='any' />\n"
                    + "         <oncancel>\n"
                    + "          <rake buildfile=\"cancel-build-file-2\" />\n"
                    + "         </oncancel>\n"
                    + "        </rake>\n"
                    + "        </tasks>\n"
                    + "      </job>\n"
