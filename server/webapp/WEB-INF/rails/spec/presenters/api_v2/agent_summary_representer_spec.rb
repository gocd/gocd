...
describe ApiV2::AgentSummaryRepresenter do
  ...
  it 'renders an agent summary' do
    presenter = ApiV2::AgentSummaryRepresenter.new(EnvironmentAgentConfig.new('agent-uuid'))
    ...
    expect(actual_json).to have_link(:doc).with_url(com.thoughtworks.go.CurrentGoCDVersion.apiDocsUrl '#agents')
