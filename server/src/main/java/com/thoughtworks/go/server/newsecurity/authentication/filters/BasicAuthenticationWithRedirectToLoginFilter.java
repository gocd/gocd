...
@Component
public class BasicAuthenticationWithRedirectToLoginFilter extends AbstractBasicAuthenticationFilter {

    @Autowired
    public BasicAuthenticationWithRedirectToLoginFilter(SecurityService securityService,
                                                        PasswordBasedPluginAuthenticationProvider authenticationProvider) {
        super(securityService, authenticationProvider, new RedirectToLoginPageHandler());
    }
