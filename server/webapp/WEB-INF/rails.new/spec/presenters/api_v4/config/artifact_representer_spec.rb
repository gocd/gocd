...
describe ApiV4::Config::ArtifactRepresenter do
  it 'should serialize build artifact' do
    presenter   = ApiV4::Config::ArtifactRepresenter.new(ArtifactPlan.new('target/dist.jar', 'pkg'))
  ...
  it 'should serialize test artifact' do
    ...
    presenter   = ApiV4::Config::ArtifactRepresenter.new(config)
    actual_json = presenter.to_hash(url_builder: UrlBuilder.new)
  ...
  it 'should deserialize test artifact' do
    ...
    presenter = ApiV4::Config::ArtifactRepresenter.new(actual)
  ...
  it 'should map errors' do
    ...
    presenter   = ApiV4::Config::ArtifactRepresenter.new(plan)
    actual_json = presenter.to_hash(url_builder: UrlBuilder.new)
