...
class PackagesControllerV1Test implements SecurityServiceTrait, ControllerTrait<PackagesControllerV1>, DeprecatedApiTrait {
  @Mock
  ...
  @Override
  PackagesControllerV1 createControllerInstance() {
    new PackagesControllerV1(new ApiAuthenticationHelper(securityService, goConfigService), entityHashingService, packageDefinitionService)
  }
