...
public class MaxBackTrackLimitReachedException extends RuntimeException {
    public MaxBackTrackLimitReachedException(MaterialConfig material) {
        super("Maximum Backtracking limit reached while trying to resolve revisions for material " + material);
    }
}
