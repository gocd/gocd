...
class ConfigReposConfigRepresenterV4Test {
  ...
  @Test
  void toJSON() {
    String actual = toObjectString({ w -> ConfigReposConfigRepresenterV4.toJSON(w, new ConfigReposConfig(repo(ID_1), repo(ID_2))) })
