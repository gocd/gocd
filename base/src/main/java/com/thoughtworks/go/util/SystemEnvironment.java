...
public class SystemEnvironment implements Serializable, ConfigDirProvider {
    ...
    public static GoSystemProperty<String> GO_DATA_SHARING_POST_USAGE_DATA_SERVER_URL = new GoStringSystemProperty("go.datasharing.server.url", "https://datasharing.gocd.org/usagedata");
