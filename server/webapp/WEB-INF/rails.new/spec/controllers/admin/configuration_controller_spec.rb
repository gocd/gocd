...
describe Admin::ConfigurationController do
  ...
  describe :update do
    ...
    it "should render split pane when config save fails because of merge conflict" do
      ...
      assigns[:flash_help_link].should == "<a class='' href='https://www.gocd.io/documentation/user/current/configuration/configuration_reference.html' target='_blank'>Help Topic: Configuration</a>"
