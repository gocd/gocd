...
class Log4jLogger
  ...
  class Logger
    ...
    # disabled by default, so that the log level can be controlled by logback configuration
    # uncomment these lines to enable debugging in development environment
    def level=(lvl)
