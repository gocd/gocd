...
class ConfigRepoDocumentMother {
    ...
    private Map<String, Object> getJSONFor(String fileName) {
        try (InputStream is = Objects.requireNonNull(this.getClass().getResourceAsStream(fileName))) {
            String transformJSON = new String(is.readAllBytes(), StandardCharsets.UTF_8);
