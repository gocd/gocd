...
public class SvnPoller implements MaterialPoller<SvnMaterial> {

    @Override
    public List<Modification> latestModification(SvnMaterial material, File baseDir, SubprocessExecutionContext execCtx) {
