  ...
  describe :index do
    ...
    describe 'logged in' do
      ...
      it 'should get agents json' do
        ...
        expect(actual_response).to eq(expected_response(two_agents, ApiV3::AgentsRepresenter))
      end
  ...
  describe :show do
    ...
    describe 'logged in' do
      ...
      it 'should get agents json' do
        ...
        expect(response).to be_ok
        expect(actual_response).to eq(expected_response([agent, %w()], ApiV3::AgentRepresenter))
      end
