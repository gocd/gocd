...
describe ApiV1::Admin::Internal::PackageCheckConnectionController do
  ...
  describe 'route' do
    describe 'with_header' do
      ...
      it 'should route to check_connection action of the repository check connection controller' do
        expect(:post => 'api/admin/internal/package_check_connection').to route_to(action: 'check_connection', controller: 'api_v1/admin/internal/package_check_connection')
      end
    end
    describe 'without_header' do
      ...
      it 'should not route to check_connection action of repository check connection controller without header' do
        expect(:post => 'api/admin/internal/package_check_connection').to_not route_to(action: 'check_connection', controller: 'api_v1/admin/internal/package_check_connection')
  ...
  describe 'admin' do
    ...
    it 'should return the successful response for a valid package repo' do
      ...
      post_with_api_header :check_connection, package_check_connection: @package_definition
