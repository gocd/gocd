...
describe ApiV1::Config::ParamRepresenter do

  it "should represent a param" do
    presenter = ApiV1::Config::ParamRepresenter.new(ParamConfig.new("command","echo"))
    actual_json = presenter.to_hash(url_builder: UrlBuilder.new)
    expect(actual_json).to eq(param_hash)
  end

  it "should deserialize" do
    presenter = ApiV1::Config::ParamRepresenter.new(ParamConfig.new)
