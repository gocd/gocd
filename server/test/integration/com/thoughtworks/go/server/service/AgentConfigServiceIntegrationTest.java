...
public class AgentConfigServiceIntegrationTest {
    ...
    public void shouldAddResourcestoTheSpecifiedAgents() throws Exception {
        ...
        assertTrue(cruiseConfig.agents().getAgentByUuid(agentConfig1.getUuid()).getResources().contains(new Resource("resource1")));
        assertTrue(cruiseConfig.agents().getAgentByUuid(agentConfig1.getUuid()).getResources().contains(new Resource("resource2")));
    }
    ...
    public void shouldRemoveResourcesFromTheSpecifiedAgents() throws Exception {
        ...
        assertTrue(cruiseConfig.agents().getAgentByUuid(agentConfig1.getUuid()).getResources().contains(new Resource("resource-1")));
        assertThat(cruiseConfig.agents().getAgentByUuid(agentConfig2.getUuid()).getResources().size(), is(0));
    }
    ...
    public void shouldAddProvidedAgentsToTheSpecifiedEnvironments() throws Exception {
        ...
        assertTrue(result.isSuccessful());
        assertTrue(result.toString(), result.toString().contains("BULK_AGENT_UPDATE_SUCESSFUL"));
        assertTrue(goConfigDao.load().getEnvironments().find(new CaseInsensitiveString("Dev")).hasAgent(agentConfig1.getUuid()));
        assertTrue(goConfigDao.load().getEnvironments().find(new CaseInsensitiveString("Dev")).hasAgent(agentConfig2.getUuid()));
    }
    ...
    public void shouldRemoveProvidedAgentsFromTheSpecifiedEnvironments() throws Exception {
        ...
        assertTrue(devEnvironment.hasAgent(agentConfig1.getUuid()));
        assertTrue(testEnvironment.hasAgent(agentConfig1.getUuid()));
    ...
    public void shouldNotAddAgentToNonExistingEnvironment() throws Exception {
        ...
        assertFalse(result.isSuccessful());
        assertThat(result.toString(), result.httpCode(), is(400));
        assertTrue(result.toString(), result.toString().contains("ENV_NOT_FOUND"));
        assertTrue(result.toString(), result.toString().contains("Non-Existing-Environment"));
    }
    ...
    public void shouldNotRemoveAgentFromNonExistingEnvironment() throws Exception {
        ...
        assertThat(result.toString(), result.httpCode(), is(400));
        assertTrue(result.toString(), result.toString().contains("ENV_NOT_FOUND"));
        assertTrue(result.toString(), result.toString().contains("NonExistingEnvironment"));
    }
    ...
    public void shouldUpdateResourcesEnvironmentsAndAgentStateOfTheProvidedStatesAllTogether() throws Exception {
        ...
        assertTrue(cruiseConfig.agents().getAgentByUuid(agentConfig2.getUuid()).isDisabled());
        assertTrue(cruiseConfig.agents().getAgentByUuid(agentConfig1.getUuid()).getResources().contains(new Resource("resource1")));
        assertTrue(cruiseConfig.agents().getAgentByUuid(agentConfig2.getUuid()).getResources().contains(new Resource("resource1")));
        assertTrue(cruiseConfig.getEnvironments().find(new CaseInsensitiveString("Dev")).hasAgent(agentConfig1.getUuid()));
        assertTrue(cruiseConfig.getEnvironments().find(new CaseInsensitiveString("Dev")).hasAgent(agentConfig2.getUuid()));
    }
}
