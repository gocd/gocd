...
describe ApiV3::Admin::Pipelines::TimerRepresenter do
  ...
  it "should deserialize" do
    presenter           = ApiV3::Admin::Pipelines::TimerRepresenter.new(com.thoughtworks.go.config.TimerConfig.new)
