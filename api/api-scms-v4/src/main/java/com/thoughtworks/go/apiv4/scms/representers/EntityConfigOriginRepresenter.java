...
import com.thoughtworks.go.apiv4.scms.representers.configorigin.ConfigRepoOriginRepresenter;
import com.thoughtworks.go.apiv4.scms.representers.configorigin.ConfigXmlOriginRepresenter;
...
public class EntityConfigOriginRepresenter {
    ...
    private static void jsoninzeConfigXmlOrigin(OutputWriter originWriter) {
        ConfigXmlOriginRepresenter.toJSON(originWriter);
    }
