...
module ApiV1
  class PipelineInstanceRepresenter < ApiV1::BaseRepresenter
      ...
      [
        {
          ...
          href:         opts[:url_builder].pipeline_instance_by_counter_api_url(pipeline_instance.getName(), pipeline_instance.getCounter())
        }
      ]
    end
    ...
    property :scheduled_time, exec_context: :decorator
