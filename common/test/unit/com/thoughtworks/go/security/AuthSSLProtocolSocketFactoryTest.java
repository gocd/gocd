...
import static com.thoughtworks.go.util.SystemEnvironment.GO_SSL_TRANSPORT_PROTOCOL_TO_BE_USED_BY_AGENT;
...
public class AuthSSLProtocolSocketFactoryTest {
    ...
    public void shouldRecreateSslSessionIfInitialisedWithEmptyKeystore()
        ...
        assertThat(newSslContext.getProtocol(), is(new SystemEnvironment().get(GO_SSL_TRANSPORT_PROTOCOL_TO_BE_USED_BY_AGENT)));
    }
}
