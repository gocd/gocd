...
describe ApiV3::Config::StageAuthorizationRepresenter do
  it 'should render stage authorization with hal representation' do
    presenter = ApiV3::Config::StageAuthorizationRepresenter.new(get_admins_config)
  ...
  it "should convert from document to AdminsConfig" do
    ...
    ApiV3::Config::StageAuthorizationRepresenter.new(admins_config).from_hash(stage_authorization_hash)
