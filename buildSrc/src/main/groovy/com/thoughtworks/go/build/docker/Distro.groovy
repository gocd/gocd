...
enum Distro implements DistroBehavior {
  ...
  alpine{
    ...
    List<String> getInstallJavaCommands(Project project) {
      // Copied verbatim from https://github.com/AdoptOpenJDK/openjdk-docker/blob/436253bad9e494ea0043da22fca197e6055a538a/15/jdk/alpine/Dockerfile.hotspot.releases.slim#L24-L55
      return [
        '# install glibc and zlib for adoptopenjdk',
        '# See https://github.com/AdoptOpenJDK/openjdk-docker/blob/436253bad9e494ea0043da22fca197e6055a538a/15/jdk/alpine/Dockerfile.hotspot.releases.slim#L24-L55',
