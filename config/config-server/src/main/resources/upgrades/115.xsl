...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/cruise/@schemaVersion">
        <xsl:attribute name="schemaVersion">115</xsl:attribute>
    </xsl:template>
    <xsl:template match="/cruise/config-repos/config-repo/git/@materialName"/>
    <xsl:template match="/cruise/config-repos/config-repo/svn/@materialName"/>
