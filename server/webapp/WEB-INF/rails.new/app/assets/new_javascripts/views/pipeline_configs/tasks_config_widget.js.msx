...
define([
  'mithril', 'lodash', 'jquery', 'helpers/form_helper', 'helpers/dragula_config', 'models/pipeline_configs/tasks',
  'models/pipeline_configs/pluggable_tasks',
  'helpers/mithril_component_mixins', 'views/pipeline_configs/task_views_widget', 'models/pipeline_configs/plugin_infos'
],
  function (m, _, $, f, dragulaConfig, Tasks, PluggableTasks,
