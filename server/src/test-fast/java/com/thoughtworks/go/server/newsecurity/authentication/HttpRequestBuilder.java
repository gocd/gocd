...
package com.thoughtworks.go.server.newsecurity.authentication;
...
public class HttpRequestBuilder {
    ...
    public HttpRequestBuilder withCookies(Cookie... cookies) {
        ...
        List<Cookie> existingCookies = requestCookies != null ? Arrays.asList(requestCookies) : Collections.emptyList();
    ...
    private HttpRequestBuilder withHeader(String name, String value) {
