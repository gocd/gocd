...
import com.thoughtworks.go.apiv4.configrepos.representers.ConfigReposConfigRepresenterV4;
...
public class ConfigReposControllerV4 extends ApiController implements SparkSpringController, CrudController<ConfigRepoConfig> {
    ...
    public ConfigRepoConfig buildEntityFromRequestBody(Request req) {
        ...
        return ConfigRepoConfigRepresenterV4.fromJSON(jsonReader);
    }

    @Override
    public Consumer<OutputWriter> jsonWriter(ConfigRepoConfig repo) {
        return w -> ConfigRepoConfigRepresenterV4.toJSON(w, repo);
    }
