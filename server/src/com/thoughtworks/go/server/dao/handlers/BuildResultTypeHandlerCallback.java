 ...
 *
 */
public class BuildResultTypeHandlerCallback implements TypeHandlerCallback {
    ...
    public Object getResult(ResultGetter resultGetter) throws SQLException {
        return Enum.valueOf(JobResult.class, resultGetter.getString());
    }

    public Object valueOf(String text) {
        return Enum.valueOf(JobResult.class, text);
    }
}
