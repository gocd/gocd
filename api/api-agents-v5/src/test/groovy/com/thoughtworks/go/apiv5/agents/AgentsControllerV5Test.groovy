...
class AgentsControllerV5Test implements SecurityServiceTrait, ControllerTrait<AgentsControllerV5> {
  ...
  @Override
  AgentsControllerV5 createControllerInstance() {
    return new AgentsControllerV5(agentService, new ApiAuthenticationHelper(securityService, goConfigService), securityService, environmentConfigService)
  }
