...
public interface ElasticAgentProcessorRequestsV1 {
    String PROCESSOR_PREFIX = "go.processor.elastic-agents";

    String REQUEST_DISABLE_AGENTS = PROCESSOR_PREFIX + ".disable-agents";
    String REQUEST_DELETE_AGENTS = PROCESSOR_PREFIX + ".delete-agents";
