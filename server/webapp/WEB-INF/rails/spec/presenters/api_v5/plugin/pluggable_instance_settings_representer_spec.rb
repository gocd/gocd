...
describe ApiV5::Plugin::PluggableInstanceSettingsRepresenter do
  it 'should describe plugin settings' do
    ...
    actual_json = ApiV5::Plugin::PluggableInstanceSettingsRepresenter.new(package_settings).to_hash(url_builder: UrlBuilder.new)
