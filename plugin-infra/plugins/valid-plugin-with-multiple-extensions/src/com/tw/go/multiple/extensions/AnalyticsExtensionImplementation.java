...
@Extension
public class AnalyticsExtensionImplementation implements GoPlugin {
    ...
    public void initializeGoApplicationAccessor(GoApplicationAccessor goApplicationAccessor) {
        System.setProperty("valid-plugin-with-multiple-extensions.analytics_extension.initialize_accessor.count", String.valueOf(++numberOfCallsToInitialize));
        System.setProperty("valid-plugin-with-multiple-extensions.analytics_extension.initialize_accessor.value", String.valueOf(System.currentTimeMillis()));
    }
