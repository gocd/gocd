...
@Component
public class JobStatusPluginQueueHandler extends PluginMessageQueueHandler<JobStatusPluginMessage> {
    final static String QUEUE_NAME_PREFIX = JobStatusPluginQueueHandler.class.getSimpleName() + ".";

    @Autowired
    public JobStatusPluginQueueHandler(final MessagingService messaging, final ElasticAgentPluginRegistry elasticAgentPluginRegistry, ElasticAgentExtension elasticAgentExtension, PluginManager pluginManager, final SystemEnvironment systemEnvironment) {
            ...
            public ListenerFactory listener() {
                return new ListenerFactory() {
                    ...
                    public GoMessageListener create() {
                        return new JobStatusPluginListener(elasticAgentPluginRegistry);
                    }
                };
            }
        });
