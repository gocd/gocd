...
public class AgentsEntityConfigUpdateCommand implements EntityConfigUpdateCommand<Agents> {
    ...
    private final TriState enable;
    private final List<String> resourcesToAdd;
    private final List<String> resourcesToRemove;
    private GoConfigService goConfigService;
    public Agents agents;

    public AgentsEntityConfigUpdateCommand(Username username, LocalizedOperationResult result, List<String> uuids, List<String> environmentsToAdd, List<String> environmentsToRemove, TriState enable, List<String> resourcesToAdd, List<String> resourcesToRemove, GoConfigService goConfigService) {
