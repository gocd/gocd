...
public class GitTestRepo extends TestRepo {
    private static final String GIT_3_REVISIONS_BUNDLE = "../domain/src/test/resources/data/repos/git/git-3-revisions.git";
    public static final String GIT_FOO_BRANCH_BUNDLE = "../domain/src/test/resources/data/repos/git/foo-branch.git";
    public static final String GIT_SUBMODULE_REF_BUNDLE = "../domain/src/test/resources/data/repos/git/referenced-submodule.git";
    public static final String GIT_CUSTOM_REFS_BUNDLE = "../domain/src/test/resources/data/repos/git/custom-refs.git";
