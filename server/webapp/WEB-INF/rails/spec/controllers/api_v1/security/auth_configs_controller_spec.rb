  ...
  describe "show" do
    describe "security" do
      ...
      it 'should disallow anonymous users, with security enabled' do
        ...
        expect(controller).to disallow_action(:get, :show, params:{auth_config_id: 'foo'}).with(403, 'You are not authorized to perform this action.')
      end
  ...
  describe "update" do
    describe "security" do
      ...
      it 'should disallow anonymous users, with security enabled' do
        ...
        expect(controller).to disallow_action(:put, :update, params:{auth_config_id: 'foo'}).with(403, 'You are not authorized to perform this action.')
      end
  ...
  describe "destroy" do
    describe "security" do
      ...
      it 'should disallow anonymous users, with security enabled' do
        ...
        expect(controller).to disallow_action(:delete, :destroy, params:{auth_config_id: 'foo'}).with(403, 'You are not authorized to perform this action.')
      end
