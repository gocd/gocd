...
abstract class ArtifactStoreCommand extends PluginProfileCommand<ArtifactStore, ArtifactStores> {
    protected final ArtifactExtension extension;

    public ArtifactStoreCommand(GoConfigService goConfigService, ArtifactStore newArtifactStore, ArtifactExtension extension, Username currentUser, LocalizedOperationResult result) {
