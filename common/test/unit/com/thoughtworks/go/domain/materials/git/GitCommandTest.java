...
public class GitCommandTest {
    ...
    protected String repoUrl() {
        return gitRepo.projectRepositoryUrl();
    }

    protected GitCommand getGitCommand() {
        return new GitCommand(null, gitLocalRepoDir, GitMaterialConfig.DEFAULT_BRANCH, false, new HashMap<String, String>(), null);
    }
    ...
    public void shouldDefaultToMasterIfNoBranchIsSpecified() {
        assertThat((String) ReflectionUtil.getField(new GitCommand(null, gitLocalRepoDir, null, false, new HashMap<String, String>(), null), "branch"), Is.is("master"));
        assertThat((String) ReflectionUtil.getField(new GitCommand(null, gitLocalRepoDir, " ", false, new HashMap<String, String>(), null), "branch"), Is.is("master"));
        assertThat((String) ReflectionUtil.getField(new GitCommand(null, gitLocalRepoDir, "master", false, new HashMap<String, String>(), null), "branch"), Is.is("master"));
        assertThat((String) ReflectionUtil.getField(new GitCommand(null, gitLocalRepoDir, "branch", false, new HashMap<String, String>(), null), "branch"), Is.is("branch"));
    }
    ...
    public void shouldCloneFromBranchWhenMaterialPointsToABranch() throws IOException {
        gitLocalRepoDir = createTempWorkingDirectory();
        git = new GitCommand(null, gitLocalRepoDir, BRANCH, false, new HashMap<String, String>(), null);
        GitCommand branchedGit = new GitCommand(null, gitLocalRepoDir, BRANCH, false, new HashMap<String, String>(), null);
    ...
    public void shouldOutputSubmoduleRevisionsAfterUpdate() throws Exception {
        ...
        GitCommand gitWithSubmodule = new GitCommand(null, createTempWorkingDirectory(), GitMaterialConfig.DEFAULT_BRANCH, false, new HashMap<String, String>(), null);
    ...
    public void shouldReturnNothingForModificationsSinceIfARebasedCommitSHAIsPassed() throws IOException {
        ...
        GitCommand command = new GitCommand(remoteRepo.createMaterial().getFingerprint(), gitLocalRepoDir, "master", false, new HashMap<String, String>(), null);
    ...
    public void shouldBombIfCheckedForModificationsSinceWithANonExistentRef() throws IOException {
        ...
        executeOnGitRepo("git", "remote", "rm", "origin");
        executeOnGitRepo("git", "remote", "add", "origin", remoteRepo.projectRepositoryUrl());
        GitCommand command = new GitCommand(remoteRepo.createMaterial().getFingerprint(), gitLocalRepoDir, "non-existent-branch", false, new HashMap<String, String>(), null);
    ...
    public void shouldRetrieveFilenameForInitialRevision() throws IOException {
        ...
        GitCommand gitCommand = new GitCommand(null, testRepo.gitRepository(), GitMaterialConfig.DEFAULT_BRANCH, false, new HashMap<String, String>(), null);
    ...
    public void shouldRetrieveLatestModificationFromBranch() throws Exception {
        ...
        GitCommand branchedGit = new GitCommand(null, createTempWorkingDirectory(), BRANCH, false, new HashMap<String, String>(), null);
    ...
    public void shouldFailGitCommandExecutionWhenProtocolIsDisallowed() throws Exception {
        ...
        GitCommand.checkConnection(new UrlArgument(repoUrl()), "master", testSubprocessExecutionContext.getDefaultEnvironmentVariables());
    }
    ...
    public void shouldFailGitCloneWhenProtocolIsDisallowed() throws Exception {
        ...
        GitCommand gitCommand = new GitCommand("unique-material", null, "master", false, executionContext.getDefaultEnvironmentVariables(), null);
        InMemoryStreamConsumer outputStreamConsumer = inMemoryConsumer();
        gitCommand.cloneFrom(outputStreamConsumer, repoUrl());
    ...
    public void shouldThrowExceptionWhenRemoteBranchDoesNotExist() throws Exception {
        GitCommand.checkConnection(new UrlArgument(repoUrl()), "Invalid_Branch", testSubprocessExecutionContext.getDefaultEnvironmentVariables());
    }
    ...
    public void shouldCleanUnversionedFilesInsideSubmodulesBeforeUpdating() throws Exception {
        ...
        GitCommand clonedCopy = new GitCommand(null, cloneDirectory, GitMaterialConfig.DEFAULT_BRANCH, false, new HashMap<String, String>(), null);
        InMemoryStreamConsumer outputStreamConsumer = inMemoryConsumer();
    ...
    private File checkInNewRemoteFile() throws IOException {
        GitCommand remoteGit = new GitCommand(null, repoLocation, GitMaterialConfig.DEFAULT_BRANCH, false, new HashMap<String, String>(), null);
