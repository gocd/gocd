...
class ConfigReposConfigRepresenterV1Test {
  ...
  @Test
  void toJSON() {
    String actual = toObjectString({ w -> ConfigReposConfigRepresenterV1.toJSON(w, new ConfigReposConfig(repo(ID_1), repo(ID_2))) })
