...
public class GoVelocityViewTest {
    ...
    public void shouldSetAssetsPathVariableWhenRailsNewWithCompressedJavascriptsIsUsed() throws Exception {
        ...
        when(railsAssetsService.getAssetPath("css")).thenReturn("assets/css");
        ...
        assertThat((String) velocityContext.get(GoVelocityView.STYLESHEETS_CSS_FOLDER_PATH), is("assets/css"));
    }
