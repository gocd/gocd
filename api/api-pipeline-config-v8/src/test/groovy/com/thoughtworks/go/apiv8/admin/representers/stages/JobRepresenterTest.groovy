...
package com.thoughtworks.go.apiv8.admin.representers.stages

import com.thoughtworks.go.api.util.GsonTransformer
import com.thoughtworks.go.apiv8.admin.shared.representers.stages.JobRepresenter
...
class JobRepresenterTest {
  ...
  class Deserialize {
    ...
    void 'should convert basic hash with task to Job'() {
      ...
      def actualJobConfig = JobRepresenter.fromJSON(jsonReader)
      Assertions.assertEquals(actualJobConfig.tasks().size(), 1)
