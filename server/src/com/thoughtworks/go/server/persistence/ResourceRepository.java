...
public class ResourceRepository {
    ...
    @Autowired
    public ResourceRepository(SessionFactory sessionFactory, TransactionTemplate transactionTemplate) {
    ...
    public List<Resource> findByBuildId(long buildId) {
        return getHibernateTemplate().find(GET_RESOURCES_BY_BUILD_ID, buildId);
    }
}
