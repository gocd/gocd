    ...
    module Asia
      module Seoul
        ...
        timezone 'Asia/Seoul' do |tz|
          ...
          tz.transition 1955, 5, :o4, 116891143, 48
          tz.transition 1955, 9, :o1, 116897237, 48
          tz.transition 1956, 5, :o4, 116909431, 48
          tz.transition 1956, 9, :o1, 116915813, 48
          tz.transition 1957, 5, :o4, 116926231, 48
          tz.transition 1957, 9, :o1, 116932949, 48
          tz.transition 1958, 5, :o4, 116943703, 48
          tz.transition 1958, 9, :o1, 116950421, 48
          tz.transition 1959, 5, :o4, 116961175, 48
          tz.transition 1959, 9, :o1, 116967893, 48
          tz.transition 1960, 4, :o4, 116978647, 48
