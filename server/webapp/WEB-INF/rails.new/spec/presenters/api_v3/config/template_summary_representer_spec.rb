...
describe ApiV3::Config::TemplateSummaryRepresenter do
  ...
  it 'should render a template name and its associated pipelines in hal representation' do
    ...
    actual_json = ApiV3::Config::TemplateSummaryRepresenter.new(template_with_pipelines).to_hash(url_builder: UrlBuilder.new)
