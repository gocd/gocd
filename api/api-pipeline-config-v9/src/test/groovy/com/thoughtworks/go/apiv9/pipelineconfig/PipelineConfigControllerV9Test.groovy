...
package com.thoughtworks.go.apiv9.pipelineconfig

import com.thoughtworks.go.api.SecurityTestTrait
import com.thoughtworks.go.api.spring.ApiAuthenticationHelper
import com.thoughtworks.go.apiv9.admin.pipelineconfig.PipelineConfigControllerV9
import com.thoughtworks.go.apiv9.admin.shared.representers.PipelineConfigRepresenter
...
class PipelineConfigControllerV9Test implements SecurityServiceTrait, ControllerTrait<PipelineConfigControllerV9> {
  @Mock
  ...
  @Override
  PipelineConfigControllerV9 createControllerInstance() {
    return new PipelineConfigControllerV9(pipelineConfigService, pipelinePauseService, new ApiAuthenticationHelper(securityService, goConfigService), entityHashingService, passwordDeserializer, goConfigService, goCache)
  }
