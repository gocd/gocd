...
public class PipelineSelectionsHelper {
    public static PipelineSelections with(List<String> pipelines, Timestamp date, Long userId, boolean blacklist) {
    ...
    public static PipelineSelections with(List<String> pipelines) {
        return with(pipelines, new Timestamp(0  ), null, true);
    }
}
