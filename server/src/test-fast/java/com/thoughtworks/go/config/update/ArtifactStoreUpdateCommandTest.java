...
public class ArtifactStoreUpdateCommandTest {
    @Rule
    ...
    public void shouldRaiseErrorWhenUpdatingNonExistentArtifactStore() throws Exception {
        ...
        ArtifactStoreUpdateCommand command = new ArtifactStoreUpdateCommand(null, artifactStore, null, null, new HttpLocalizedOperationResult(), null, null);
    ...
    public void shouldUpdateExistingArtifactStore() throws Exception {
        ...
        ArtifactStoreUpdateCommand command = new ArtifactStoreUpdateCommand(null, newArtifactStore, null, null, null, null, null);
    ...
    public void shouldNotContinueWithConfigSaveIfRequestIsNotFresh() {
        ...
        ArtifactStoreUpdateCommand command = new ArtifactStoreUpdateCommand(goConfigService, newArtifactStore, null, currentUser, result, entityHashingService, "bad-md5");
