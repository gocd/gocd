...
describe("Drain Mode Disabled subsystem Widget", () => {
  ...
  describe("Not During Drain Mode", () => {
    ...
    it("should provide header information of what will be disabled during drain mode", () => {
      const expectedHeader = "Enabling GoCD Server Drain mode will:";
  ...
  //private
  function mount(drainModeInfo: DrainModeInfo) {
    m.mount(root, {
      view() {
        return (<DisabledSubsystemsWidget drainModeInfo={drainModeInfo}/>);
      }
    });
