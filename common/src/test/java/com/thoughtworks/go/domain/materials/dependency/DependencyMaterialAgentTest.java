...
public class DependencyMaterialAgentTest {
    ...
    public void shouldBeCreatedByAgentFactory() {
        MaterialAgentFactory factory = new MaterialAgentFactory(new File("blah"), new AgentIdentifier("", "", ""), null, null);
        MaterialAgent createdAgent = factory.createAgent(materialRevision("pipeline-name", 1, "pipeline-label", "stage-name", 1), ProcessOutputStreamConsumer.inMemoryConsumer());
