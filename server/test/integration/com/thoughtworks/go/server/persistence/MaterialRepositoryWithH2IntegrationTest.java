...
public class MaterialRepositoryWithH2IntegrationTest {
    ...
    public void materialFingerprintShouldUseTheHashAlgoritmInMigration47() throws Exception {
        ...
        byte[] fingerprint = repo.getHibernateTemplate().execute(new HibernateCallback<byte[]>() {
            public byte[] doInHibernate(Session session) throws HibernateException, SQLException {
