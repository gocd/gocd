...
describe Admin::ConfigurationController do
  ...
  describe 'update' do
    ...
    it "should render split pane when config save fails because of merge conflict" do
      ...
      expect(assigns[:flash_help_link]).to eq("<a class='' href='http://www.go.cd/documentation/user/current/configuration/configuration_reference.html' target='_blank'>Help Topic: Configuration</a>")
