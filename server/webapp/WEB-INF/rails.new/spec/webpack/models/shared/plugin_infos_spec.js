...
describe('PluginInfos', () => {
  ...
  describe("ElasticAgent", () => {
    it("should deserialize", () => {
      ...
      expect(pluginInfo.profileSettings().viewTemplate()).toEqual(json.extensions[0].profile_settings.view.template);
      ...
      expect(pluginInfo.pluginSettings().viewTemplate()).toEqual(json.extensions[0].plugin_settings.view.template);
  ...
  describe("Task", () => {
    it("should deserialize", () => {
      ...
      expect(pluginInfo.taskSettings().viewTemplate()).toEqual(json.extensions[0].task_settings.view.template);
  ...
  describe("SCM", () => {
    it("should deserialize", () => {
      ...
      expect(pluginInfo.scmSettings().viewTemplate()).toEqual(json.extensions[0].scm_settings.view.template);
  ...
  describe("Authorization", () => {
    it("should deserialize", () => {
      ...
      expect(pluginInfo.authConfigSettings().viewTemplate()).toEqual(json.extensions[0].auth_config_settings.view.template);
      ...
      expect(pluginInfo.roleSettings().viewTemplate()).toEqual(json.extensions[0].role_settings.view.template);
  ...
  describe("Artifact", () => {
    it("should deserialize", () => {
      ...
      expect(pluginInfo.storeConfigSettings().viewTemplate()).toEqual(json.extensions[0].store_config_settings.view.template);
      ...
      expect(pluginInfo.artifactConfigSettings().viewTemplate()).toEqual(json.extensions[0].artifact_config_settings.view.template);
      ...
      expect(pluginInfo.fetchArtifactSettings().viewTemplate()).toEqual(json.extensions[0].fetch_artifact_settings.view.template);
  ...
  const verifyBasicProperties = (pluginInfo, {id, about, status, extensions}) => {
    ...
    expect(pluginInfo.type()).toEqual(extensions[0].type);
    expect(pluginInfo.extensions().length).toBeGreaterThanOrEqual(1);
