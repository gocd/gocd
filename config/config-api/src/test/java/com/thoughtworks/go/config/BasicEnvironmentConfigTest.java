...
class BasicEnvironmentConfigTest extends EnvironmentConfigTestBase {
    ...
    class Validate {
        ...
        void shouldNotAllowToReferencePipelineDefinedInConfigRepo_WhenEnvironmentDefinedInFile() {
            ...
            EnvironmentPipelineConfig reference = environmentConfig.getPipelines().getFirst();
    ...
    class ValidateTree {
        ...
        void shouldValidateEnvVariables() {
            ...
            assertThat(configErrors.getFirst().firstErrorOn("name")).isEqualTo("Environment Variable cannot have an empty name for environment 'UAT'.");
        }
