...
public class RunOnAllAgentsJobTypeConfig implements JobTypeConfig {
    public static final String MARKER = "runOnAll"; // This should ideally be owned by JobNameGenerator - Rajesh & JJ
    ...
    public static boolean hasMarker(String s) {
        return RunOnAllAgentsJobTypeConfig.MARKER_PATTERN.matcher(s).find();
    }
}
