...
define(['lodash', "pipeline_configs/models/tasks", "string-plus", 'pipeline_configs/models/plugins'],
  function (_, Tasks, s, Plugins) {
    ...
    describe("Plugin Task", function () {
      ...
      describe('from plugin', function() {
        it('should be created from a plugin', function() {
          ...
          var task = Tasks.Task.PluginTask.fromPlugin(plugin);
