...
class BuildCauseControllerDelegateTest implements ControllerTrait<BuildCauseControllerDelegate>, SecurityServiceTrait {
  ...
  @Override
  BuildCauseControllerDelegate createControllerInstance() {
    new BuildCauseControllerDelegate(pipelineHistoryService, new ApiAuthenticationHelper(securityService, goConfigService))
  }
