...
class ArtifactConfigControllerV1Test implements SecurityServiceTrait, ControllerTrait<ArtifactConfigControllerV1> {
  ...
  @Mock ServerConfigService serverConfigService
  ...
  class Show {
    ...
    class Security implements SecurityTestTrait, AdminUserSecurity {
      @Delegate SecurityServiceTrait s = ArtifactConfigControllerV1Test.this
      @Delegate ControllerTrait<ArtifactConfigControllerV1> c = ArtifactConfigControllerV1Test.this
  ...
  class Update {
    ...
    class AsAdmin {
      ...
      void 'should return 422 for validation errors'() {
        ...
        doThrow(e).when(serverConfigService).updateArtifactConfig(any() as ArtifactConfig)
