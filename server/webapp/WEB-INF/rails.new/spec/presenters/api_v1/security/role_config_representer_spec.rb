...
describe ApiV1::Security::RoleConfigRepresenter do
  ...
  it 'should serialize to json' do
    ...
    expect(actual_json).to eq(name: 'foo', users: %w(bob alice))
  end

  it 'should deserialize from json' do
    new_role = ApiV1::Security::RoleConfigRepresenter.new(RoleConfig.new).from_hash(name: 'foo', users: %w(bob alice))
