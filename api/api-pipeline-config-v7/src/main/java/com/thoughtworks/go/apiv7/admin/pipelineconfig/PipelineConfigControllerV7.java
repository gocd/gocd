...
public class PipelineConfigControllerV7 extends ApiController implements SparkSpringController, CrudController<PipelineConfig> {
    ...
    @Autowired
    public PipelineConfigControllerV7(PipelineConfigService pipelineConfigService, ApiAuthenticationHelper apiAuthenticationHelper, EntityHashingService entityHashingService, PasswordDeserializer passwordDeserializer, GoConfigService goConfigService) {
        super(ApiVersion.v7);
