...
public abstract class AbstractSesameResource implements Resource {
    private final org.eclipse.rdf4j.model.Resource sesameNativeResource;

    public AbstractSesameResource(org.eclipse.rdf4j.model.Resource sesameNativeResource) {
        this.sesameNativeResource = sesameNativeResource;
    }

    org.eclipse.rdf4j.model.Resource getSesameNativeResource() {
