...
public class AdminTemplatesController implements SparkController {
    ...
    public AdminTemplatesController(SpaAuthorizationHelper authorizationHelper, TemplateEngine engine) {
    ...
    public void setupRoutes(GlobalExceptionMapper exceptionMapper) {
        path(controllerBasePath(), () -> {
            before("", authorizationHelper::checkViewAccessToTemplateAnd403);
