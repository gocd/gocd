...
public class AgentInstanceMother {
    ...
    public static AgentInstance idle() {
        return idle(Instant.now(), "CCeDev01");
    }
    ...
    public static AgentInstance idle(final Instant lastHeardAt, final String hostname, SystemEnvironment systemEnvironment) {
    ...
    public static AgentInstance idle(final Instant lastHeardAt, final String hostname) {
