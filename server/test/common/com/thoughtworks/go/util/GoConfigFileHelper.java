...
public class GoConfigFileHelper {
    ...
    public void addLdapSecurity(String uri, String managerDn, String managerPassword, String searchBase,
                                String searchFilter, String displayName) {
        LdapConfig ldapConfig = new LdapConfig(uri, managerDn, managerPassword, null, true, new BasesConfig(new BaseConfig(searchBase)), searchFilter, displayName);
    ...
    public void addLdapSecurityWithAdmin(String uri, String managerDn, String managerPassword, String searchBase,
                                         String searchFilter, String adminUser, String displayName) {
        LdapConfig ldapConfig = new LdapConfig(uri, managerDn, managerPassword, null, true, new BasesConfig(new BaseConfig(searchBase)), searchFilter, displayName);
    ...
    public void addSecurityWithBogusLdapConfig(boolean anonymous) {
        addLdapSecurityWith(new LdapConfig("uri", "dn", "pw", null, true, new BasesConfig(new BaseConfig("sb")), "sf", "dn"), anonymous, new PasswordFileConfig(),
                new AdminsConfig());
    }
