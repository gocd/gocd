...
describe ApiV3::Config::PropertyConfigRepresenter do
  before :each do
  ...
  it 'should serialize property' do
    presenter = ApiV3::Config::PropertyConfigRepresenter.new(@property)
  ...
  it 'should deserialize test artifact' do
    ...
    presenter = ApiV3::Config::PropertyConfigRepresenter.new(actual)
