...
class TfsSDKCommandTest {
    ...
    void setUp() {
        ...
        collection = new TFSTeamProjectCollection(URI.create(TFS_COLLECTION), new UsernamePasswordCredentials(USERNAME, PASSWORD), new VersionControlConnectionAdvisor());
