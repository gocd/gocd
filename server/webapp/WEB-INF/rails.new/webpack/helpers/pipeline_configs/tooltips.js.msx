...
let UseThis = {
  view (vnode) {
    return (<a title='Use this' onclick={_.wrap(vnode.attrs.toShow, vnode.attrs.callback)}>{vnode.attrs.toShow}</a>);
  }
};
...
let ExampleTable = {
  view (vnode) {
    return (
      <table>
        <caption>{vnode.attrs.tableTitle || 'Some Examples'}</caption>
        <tbody>
        {_.map(vnode.attrs.examples, (value, key) => {

          const toShow = vnode.attrs.callback ? (<UseThis callback={vnode.attrs.callback} toShow={key}/>) : key;

          return (
            <tr>
              <td width={vnode.attrs.firstColumnWidth}><code>{toShow}</code></td>
              <td>{value}</td>
            </tr>
          );
        })}
    ...
    return (
      <div>
        ...
        <p>
          ...
          <code><UseThis callback={vnode.attrs.callback} toShow='15.1-${COUNT}'/></code>{' '}or {' '}
          <code><UseThis callback={vnode.attrs.callback} toShow='15.1-${COUNT}-${svn}'/></code>{' '}or {' '}
          <code><UseThis callback={vnode.attrs.callback} toShow='15.1-${COUNT}-${git[:7]}'/></code>.
        </p>
...
const pipelineEnablePipelineLocking = (
  <div>
    <p>
...
const automaticPipelineScheduling = (
  <div>
    <p>
...
const manualPipelineScheduling = (
  <div>
    <p>
      This pipeline is can only be scheduled in response to a Manual/API/Timer trigger as the first stage of this
      pipeline is set to 'manual'.
    </p>
  </div>
);


const trackingToolGenericRegex = {
  view (vnode) {
    return (
      <div>
        <p>
        ...
        <ExampleTable callback={vnode.attrs.callback}
...
const trackingToolGenericUrlPattern = {
  view (vnode) {
    return (
      <div>
        <p>
...
const trackingToolMingleBaseUrl = {
  view (vnode) {
    return (
      <div>
        <p>
...
const trackingToolMingleProjectIdentifier = {
  view () {
    return (
      <div>
        <p>
...
const trackingToolMingleGroupingConditions = {
  view (vnode) {
    return (
      <div>
        <p>
...
const environmentVariables = (
  <div>
    ...
    <a href='https://docs.gocd.io/current/faq/dev_use_current_revision_in_build.html' target='_blank'>
      Read more...
    </a>
...
const materialIgnorePattern = function (word) {
  return (
    <div>
      <p>
        (Optional)
...
const pipelineTimerOnlyOnChanges = (
  <div>
    <p>
...
const pipelineParametersMain     = (
  <div>
    ...
    <a
      href='https://docs.gocd.io/current/configuration/admin_use_parameters_in_configuration.html'
      target='_blank'>
      Read more...
    </a>
  </div>
...
const task = {
  lookup:         (
                    <div>
                      ...
                      <a class=""
                         href="https://docs.gocd.io/current/advanced_usage/command_repository.html"
  ...
  main: (
          <div>
            <p>
              ...
              href="https://docs.gocd.io/current/faq/dev_see_artifact_as_tab.html"
...
const tooltips = {
  pipeline: {
    ...
    automaticPipelineScheduling,
    manualPipelineScheduling,
    timer:                 {
