...
import {ConfigRepoCapabilities} from "./configrepo_plugin_capabilities";
...
class ConfigRepoSettings extends Extension {
  ...
  static fromJSON(data: any) {
    return new ConfigRepoSettings(ConfigRepoCapabilities.fromJSON(data.capabilities), PluginSettings.tryParsing(data));
  }
}
