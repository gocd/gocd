...
class MaterialNotifyControllerV1Test implements SecurityServiceTrait, ControllerTrait<MaterialNotifyControllerV1> {
  ...
  @Override
  MaterialNotifyControllerV1 createControllerInstance() {
    return new MaterialNotifyControllerV1(new ApiAuthenticationHelper(securityService, goConfigService), materialUpdateService)
  }
  ...
  class Git {
    ...
    class AsAdmin {
      ...
      @Test
      void 'should return 422 when uuid not found for svn'() {
        def payload = [foo: "bar"]
