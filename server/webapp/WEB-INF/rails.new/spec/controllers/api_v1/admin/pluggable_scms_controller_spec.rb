...
describe ApiV1::Admin::PluggableScmsController do
  before :each do
    @scm = SCM.new("1", PluginConfiguration.new("github.pr", "1"),
  ...
  describe :create do
    ...
    describe 'admin' do
      ...
      it 'should deserialize scm object from given parameters' do
        hash = {id: 'scm-id', name: 'foo', auto_update: false, plugin_configuration: {id: 'github.pr', version: '1'}, configuration: [{"key" => 'url', "value" => 'git@github.com:foo/bar.git'}, {"key" => 'password', "value" => "some-value"}]}
      ...
      it 'should generate id if id is not provided by user' do
        hash = {name: 'foo', auto_update: false, plugin_configuration: {id: 'github.pr', version: '1'}, configuration: [{"key" => 'url', "value" => 'git@github.com:foo/bar.git'}, {"key" => 'password', "encrypted_value" => 'baz'}]}
        @pluggable_scm_service.should_receive(:createPluggableScmMaterial).with(anything, an_instance_of(SCM), anything)
  ...
  describe :update do
    ...
    describe 'admin' do
      ...
      it 'should deserialize scm object from given parameters' do
        ...
        hash = {id: '1', name: 'material', auto_update: false, plugin_configuration: {id: 'github.pr', version: '1'}, configuration: [{"key" => 'url', "value" => 'git@github.com:foo/bar.git'}]}
        @pluggable_scm_service.should_receive(:updatePluggableScmMaterial).with(anything, an_instance_of(SCM), anything)
        params = {material_name: 'material', id: '1', name: 'material', auto_update: false, plugin_configuration: {id: 'github.pr', version: '1'}, configuration: [{"key" => 'url', "value" => 'git@github.com:foo/bar.git'}]}
      ...
      it 'should not allow rename of material name' do
        controller.stub(:check_for_stale_request).and_return(nil)
        params = {material_name: 'foo', id: '1', name: 'material', auto_update: false, plugin_configuration: {id: 'github.pr', version: '1'}, configuration: [{"key" => 'url', "value" => 'git@github.com:foo/bar.git'}]}
      ...
      it 'should fail update if etag does not match' do
        ...
        params = {material_name: 'foo', id: '1', name: 'foo', auto_update: false, plugin_configuration: {id: 'github.pr', version: '1'}, configuration: [{"key" => 'url', "value" => 'git@github.com:foo/bar.git'}]}
