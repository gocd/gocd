...
public class BuildWorkTest {
    ...
    public void shouldReportStatus() throws Exception {
        ...
        buildWork.doWork(agentIdentifier, buildRepository, artifactManipulator, environmentVariableContext, new AgentRuntimeInfo(agentIdentifier, AgentRuntimeStatus.Idle, currentWorkingDirectory(), "cookie", false, timeProvider), packageRepositoryExtension, scmExtension, taskExtension);
    ...
    public void shouldRunTaskWhenConditionMatches() throws Exception {
        ...
        buildWork.doWork(agentIdentifier, buildRepository, artifactManipulator,
                environmentVariableContext, new AgentRuntimeInfo(agentIdentifier, AgentRuntimeStatus.Idle, currentWorkingDirectory(), "cookie", false, timeProvider), packageRepositoryExtension, scmExtension, taskExtension);
    ...
    public void shouldCreateAgentWorkingDirectoryIfNotExist() throws Exception {
        ...
        buildWork.doWork(agentIdentifier,
                buildRepository, artifactManipulator, environmentVariableContext, new AgentRuntimeInfo(agentIdentifier, AgentRuntimeStatus.Idle, currentWorkingDirectory(), "cookie", false, timeProvider), packageRepositoryExtension, scmExtension, taskExtension);
