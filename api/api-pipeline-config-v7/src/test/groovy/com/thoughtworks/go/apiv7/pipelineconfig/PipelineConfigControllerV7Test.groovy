...
class PipelineConfigControllerV7Test implements SecurityServiceTrait, ControllerTrait<PipelineConfigControllerV7> {
  ...
  PipelineConfigControllerV7 createControllerInstance() {
    return new PipelineConfigControllerV7(pipelineConfigService, new ApiAuthenticationHelper(securityService, goConfigService), entityHashingService, passwordDeserializer, goConfigService)
  }
