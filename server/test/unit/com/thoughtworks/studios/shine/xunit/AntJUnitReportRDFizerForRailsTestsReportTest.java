...
public class AntJUnitReportRDFizerForRailsTestsReportTest {
    ...
    public void canReadRailsTestWithFailureOutput() throws Exception {
        ...
        Graph graph = junitRDFizer.importFile("http://job", document(FileUtils.readFileToString(new File("test/data/ruby_xunit/failing/TEST-PostsControllerTest.xml"), UTF_8)));
    ...
    public void canReadRailsTestWithErrorOutput() throws Exception {
        ...
        AntJUnitReportRDFizer junitRDFizer = new AntJUnitReportRDFizer(new InMemoryTempGraphFactory(), XSLTTransformerRegistry);
        Graph graph = junitRDFizer.importFile("http://job", document(FileUtils.readFileToString(new File("test/data/ruby_xunit/errors/TEST-PostsControllerTest.xml"), UTF_8)));
    ...
    public void canReadRailsTestWithPassingOutput() throws Exception {
        ...
        AntJUnitReportRDFizer junitRDFizer = new AntJUnitReportRDFizer(new InMemoryTempGraphFactory(), XSLTTransformerRegistry);
        Graph graph = junitRDFizer.importFile("http://job", document(FileUtils.readFileToString(new File("test/data/ruby_xunit/passing/TEST-PurchasesControllerTest.xml"), UTF_8)));
