...
@Extension
public class DummyPluginAwareExtensionWithOneArgConstructorOnly implements PluginDescriptorAware {

    public DummyPluginAwareExtensionWithOneArgConstructorOnly(int x) {
    }
