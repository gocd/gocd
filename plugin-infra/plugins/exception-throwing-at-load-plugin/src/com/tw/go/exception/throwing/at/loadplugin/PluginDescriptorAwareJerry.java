...
@Extension
public class PluginDescriptorAwareJerry implements PluginDescriptorAware {
    ...
    public void onLoad(PluginContext context) {
        System.out.println("Jerry Plugin loaded!!! .....");
        ++loadCalled;
        throw new RuntimeException("Tom behind me!!");
    }
