...
public class MaterialModificationRepresenter {
    ...
    private static void modification(Modification modification, OutputWriter modificationWriter) {
        modificationWriter
                .add("revision_sha", modification.getRevision())
                .add("modified_by", modification.getUserDisplayName())
                .add("modified_at", modification.getModifiedTime())
                .add("commit_message", modification.getComment());
    }
}
