...
class RolesControllerV1Test implements SecurityServiceTrait, ControllerTrait<RolesControllerV1> {
  ...
  @Override
  RolesControllerV1 createControllerInstance() {
    new RolesControllerV1(roleConfigService, new ApiAuthenticationHelper(securityService, goConfigService), entityHashingService)
  }
