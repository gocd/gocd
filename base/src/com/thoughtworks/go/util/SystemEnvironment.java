...
public class SystemEnvironment implements Serializable, ConfigDirProvider {
    ...
    public static GoSystemProperty<String> AVAILABLE_FEATURE_TOGGLES_FILE_PATH = new GoStringSystemProperty("available.toggles.path", "defaultFiles/available.toggles");
