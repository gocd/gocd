...
public class ConfigSaveDeadlockDetectionIntegrationTest {
    ...
    private Thread configRepoSaveThread(final ConfigRepoConfig configRepoConfig, final int counter) throws InterruptedException {
        return createThread(() -> goPartialConfig.onSuccessPartialConfig(configRepoConfig, PartialConfigMother.withPipeline("remote-pipeline" + counter, new RepoConfigOrigin(configRepoConfig, "1"))), "config-repo-save-thread" + counter);
    }
