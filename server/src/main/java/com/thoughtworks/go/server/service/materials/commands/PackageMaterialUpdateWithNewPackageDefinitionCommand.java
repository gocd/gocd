...
public class PackageMaterialUpdateWithNewPackageDefinitionCommand extends PackageMaterialSaveCommand {
    public PackageMaterialUpdateWithNewPackageDefinitionCommand(PackageDefinitionService packageDefinitionService, SecurityService securityService, String pipeline,
