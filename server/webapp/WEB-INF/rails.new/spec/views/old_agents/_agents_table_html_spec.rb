...
describe "/old_agents/index" do
  ...
  it "should not link to agent details for a pending agent" do
    ...
    render :partial => "old_agents/agents_table.html",:locals => {:scope => {:sortable_columns => false}}
  ...
  it "should make the column sortable if sortable is true" do
    render :partial => "old_agents/agents_table.html",:locals => {:scope => {:sortable_columns => true}}
  ...
  it "should show status only for disabled agents if show_only_disabled is true" do
    render :partial => "old_agents/agents_table.html",:locals => {:scope => {:show_only_disabled => true}}
  ...
  it "should show all status by default if show_only_disabled is not given or is false" do
    render :partial => "old_agents/agents_table.html",:locals => {:scope => {}}
