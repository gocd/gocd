...
describe OldAgentsController do
  ...
  describe "GET 'index'" do
    ...
    it "should answer for /agents" do
      expect(:get => "/old_agents").to route_to({:controller => "old_agents", :action => 'index',:format => "html"})
      expect(:get => "/old_agents.html").to route_to({:controller => "old_agents", :action => 'index', :format => "html"})
      expect(:get => "/old_agents.json").to route_to({:controller => "old_agents", :action => 'index', :format => "json"})
  ...
  describe :edit_agents do
    ...
    it "should resolve routes" do
      expect(:post => "old_agents/edit_agents").to route_to({:controller => "old_agents", :action => 'edit_agents'})
  ...
  describe :resource_selector do
    ...
    it "should resolve routes" do
      ...
      expect(:post => "/old_agents/resource_selector").to route_to({:controller => "old_agents", :action => 'resource_selector'})
    end
  ...
  describe :environments_selector do
    ...
    it "should resolve routes" do
      ...
      expect(:post => "/old_agents/environment_selector").to route_to({:controller => "old_agents", :action => 'environment_selector'})
    end
