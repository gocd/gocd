...
public class SpaControllers implements SparkSpringController {
    ...
    public SpaControllers(SPAAuthenticationHelper authenticationHelper, FreemarkerTemplateEngineFactory templateEngineFactory,
                          ...
                          GoCache goCache, FeatureToggleService featureToggleService) {
        ...
        sparkControllers.add(new AgentsController(authenticationHelper, templateEngineFactory.create(AgentsController.class, () -> featureToggleService.isToggleOn(Toggles.SHOW_NEW_AGENTS_SPA) ? COMPONENT_LAYOUT_PATH : DEFAULT_LAYOUT_PATH), securityService, systemEnvironment, featureToggleService));
