...
Go::Application.routes.draw do
  ...
  namespace :admin do
    ...
    get 'status_reports/:plugin_id' => 'status_reports#index', constraints: {plugin_id: PLUGIN_ID_FORMAT}, format: false, as: :status_report
    get 'status_reports/:plugin_id/:elastic_agent_id' => 'status_reports#show', constraints: {plugin_id: PLUGIN_ID_FORMAT}, format: false, as: :agent_status_report
