...
class PluginImagesControllerDelegateTest implements ControllerTrait<SparkController> {
  ...
  @Override
  PluginImagesControllerDelegate createControllerInstance() {
    return new PluginImagesControllerDelegate(defaultPluginInfoFinder)
  }
