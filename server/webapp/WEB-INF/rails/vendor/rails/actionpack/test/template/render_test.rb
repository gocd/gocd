...
module RenderTestCases
  ...
  def test_render_file
    assert_equal "Hello world!", @view.render(:file => "test/agents.erb")
  end
  ...
  def test_render_file_without_specific_extension
    assert_equal "Hello world!", @view.render(:file => "test/agents")
  end

  def test_render_file_with_localization
    old_locale = I18n.locale
    I18n.locale = :da
    assert_equal "Hey verden", @view.render(:file => "test/agents")
  ensure
  ...
  def test_render_file_with_dashed_locale
    old_locale = I18n.locale
    I18n.locale = :"pt-BR"
    assert_equal "Ola mundo", @view.render(:file => "test/agents")
  ensure
    I18n.locale = old_locale
  end
  ...
  def test_render_file_with_full_path
    template_path = File.join(File.dirname(__FILE__), '../fixtures/test/agents.erb')
  ...
  def test_render_with_layout
    assert_equal %(<title></title>\nHello world!\n),
      @view.render(:file => "test/agents.erb", :layout => "layouts/yield")
  end
