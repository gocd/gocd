...
describe ApiV3::Admin::Environments::EnvironmentConfigRepresenter do
  ...
  describe :deserialize do
    it 'should convert from minimal json to EnvironmentConfig' do
      ...
      ApiV3::Admin::Environments::EnvironmentConfigRepresenter.new(environment_config).from_hash(environment_hash_basic)
