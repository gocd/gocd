...
describe ApiV4::Config::ApprovalRepresenter do
  it 'renders approval with hal representation' do
    approval = get_approval
    presenter = ApiV4::Config::ApprovalRepresenter.new(approval)
  ...
  it 'should convert basic hash to Approval object' do
    ...
    ApiV4::Config::ApprovalRepresenter.new(approval).from_hash(approval_hash)
