...
public class SingleJobTypeConfig implements JobTypeConfig {
    @Override
    public boolean isInstanceOf(String jobInstanceName, boolean ignoreCase, String jobConfigName) {
        return ignoreCase ? jobConfigName.equalsIgnoreCase(jobInstanceName) : jobConfigName.equals(jobInstanceName);
    }
