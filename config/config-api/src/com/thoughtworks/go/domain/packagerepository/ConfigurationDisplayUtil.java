...
public class ConfigurationDisplayUtil {
    public static List<ConfigurationProperty> getConfigurationPropertiesToBeUsedForDisplay(AbstractMetaDataStore metadataStore, String pluginId, final Configuration configuration) {
