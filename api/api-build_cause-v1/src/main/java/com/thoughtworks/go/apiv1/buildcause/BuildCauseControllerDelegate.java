...
public class BuildCauseControllerDelegate extends ApiController {
    private final PipelineHistoryService pipelineHistoryService;
    private final ApiAuthenticationHelper apiAuthenticationHelper;

    public BuildCauseControllerDelegate(PipelineHistoryService pipelineHistoryService, ApiAuthenticationHelper apiAuthenticationHelper) {
        super(ApiVersion.v1);
