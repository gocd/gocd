...
import com.thoughtworks.go.server.newsecurity.matchers.RequestHeaderMatcherFactory;
...
public class BasicAuthenticationWithChallengeFailureResponseHandler implements ResponseHandler {
    private static final RequestMatcher AJAX_MATCHER = RequestHeaderMatcherFactory.headerRequestMatcher("X-Requested-With", "XMLHttpRequest");
