...
module ApiV2
  module Config
    class TemplateSummaryRepresenter < ApiV2::BaseRepresenter

      link :self do |opts|
        opts[:url_builder].apiv2_admin_template_url(template_name: name.to_s) unless name.to_s.blank?
      end
      ...
      collection :pipelines, embedded: true, exec_context: :decorator, decorator: ApiV2::Config::PipelineConfigSummaryRepresenter
