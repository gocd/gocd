...
public class PipelineConfigSummaryRepresenter {
    public static void toJSON(OutputListWriter jsonWriter, List<PipelineConfig> pipelines) {
        pipelines.forEach(pipeline -> jsonWriter.addChild(pipelineWriter -> toJSON(pipelineWriter, pipeline)));
    }
