...
public class FullConfigSaveMergeFlowIntegrationTest {
    @Autowired
    ...
    public void shouldEncryptPluginPropertiesOfPublishTask() throws Exception {
        ...
        GoConfigHolder configHolder = fullConfigSaveMergeFlow.execute(new FullConfigUpdateCommand(cruiseConfig, goConfigService.configFileMd5()), new ArrayList<>(), "Upgrade");
