...
describe ApiV4::Plugin::PluggableInstanceSettingsRepresenter do
  it 'should describe plugin settings' do
    ...
    actual_json = ApiV4::Plugin::PluggableInstanceSettingsRepresenter.new(package_settings).to_hash(url_builder: UrlBuilder.new)
