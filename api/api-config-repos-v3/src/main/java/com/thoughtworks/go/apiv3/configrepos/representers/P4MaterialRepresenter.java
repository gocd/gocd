...
class P4MaterialRepresenter implements MaterialRepresenter<P4MaterialConfig> {

    @Override
    public void toJSON(OutputWriter json, P4MaterialConfig material) {
    ...
    @Override
    public P4MaterialConfig fromJSON(JsonReader json) {
