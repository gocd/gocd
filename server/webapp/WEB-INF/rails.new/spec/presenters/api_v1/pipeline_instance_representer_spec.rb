...
describe ApiV1::PipelineInstanceRepresenter do
  include PipelineModelMother

  it 'renders all pipeline instances with hal representation' do
    presenter = ApiV1::PipelineInstanceRepresenter.new(pipeline_instance_model_empty('p1', 's1'))
  ...
  def expected_self_links
    [
      {
        content_type: ApiV1::BaseRepresenter::CONTENT_TYPE_API_V1, href: 'http://test.host/api/pipelines/p1/instance/0'
      }
    ]
  end
end
