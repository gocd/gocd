...
class TemplateConfigControllerV4Test implements SecurityServiceTrait, ControllerTrait<TemplateConfigControllerV4> {
  ...
  @Override
  TemplateConfigControllerV4 createControllerInstance() {
    return new TemplateConfigControllerV4(templateConfigService, new ApiAuthenticationHelper(securityService, goConfigService), entityHashingService)
  }
