...
import com.thoughtworks.go.apiv2.configrepos.representers.ConfigReposRepresenterV2;
...
public class ConfigReposControllerV2 extends ApiController implements SparkSpringController {
    ...
    @Autowired
    public ConfigReposControllerV2(ApiAuthenticationHelper authHelper, ConfigRepoService service, GoRepoConfigDataSource dataSource) {
        super(ApiVersion.v2);
