  ...
  module Indexes
    module Countries
      ...
      country 'AQ', 'Antarctica' do |c|
        c.timezone 'Antarctica/McMurdo', -467, 6, 833, 5, 'New Zealand time - McMurdo, South Pole'
      ...
      country 'BR', 'Brazil' do |c|
        ...
        c.timezone 'America/Santarem', -73, 30, -823, 15, 'Para (west)'
      ...
      country 'CD', 'Congo (Dem. Rep.)' do |c|
        c.timezone 'Africa/Kinshasa', -43, 10, 153, 10, 'Dem. Rep. of Congo (west)'
        c.timezone 'Africa/Lubumbashi', -35, 3, 412, 15, 'Dem. Rep. of Congo (east)'
      end
