...
module ApiV4
  module Config
    module Tasks
      class PluggableTaskRepresenter < ApiV4::Config::Tasks::BaseTaskRepresenter
        alias_method :pluggable_task, :represented

        property :plugin_configuration, decorator: ApiV4::Config::PluginConfigurationRepresenter, class: com.thoughtworks.go.domain.config.PluginConfiguration
