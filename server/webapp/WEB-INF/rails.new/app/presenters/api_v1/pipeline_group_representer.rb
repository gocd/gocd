...
module ApiV1
  class PipelineGroupRepresenter < ApiV1::BaseRepresenter
    ...
    link :self do |opts|
      [
        {type: CONTENT_TYPE_API_V1,  href: opts[:url_builder].pipeline_group_config_list_api_url},
      ]
    end

    link :doc do
      'http://www.go.cd/documentation/user/current/api/v1/pipeline_group_api.html'
    end
