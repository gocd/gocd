...
class TemplateConfigControllerV5Test implements SecurityServiceTrait, ControllerTrait<TemplateConfigControllerV5>, DeprecatedApiTrait {
  ...
  @Override
  TemplateConfigControllerV5 createControllerInstance() {
    return new TemplateConfigControllerV5(templateConfigService, new ApiAuthenticationHelper(securityService, goConfigService), entityHashingService)
  }
