...
public class PipelineOperationsControllerV1 extends ApiController implements SparkSpringController {
    ...
    public void setupRoutes(GlobalExceptionMapper exceptionMapper) {
        path(controllerPath(), () -> {
            ...
            before(Routes.Pipeline.PAUSE_PATH, mimeType, apiAuthenticationHelper::checkPipelineGroupOperateViaNameParamsAnd403);
            before(Routes.Pipeline.UNPAUSE_PATH, mimeType, apiAuthenticationHelper::checkPipelineGroupOperateViaNameParamsAnd403);
            before(Routes.Pipeline.UNLOCK_PATH, mimeType, apiAuthenticationHelper::checkPipelineGroupOperateViaNameParamsAnd403);
            before(Routes.Pipeline.TRIGGER_OPTIONS_PATH, mimeType, apiAuthenticationHelper::checkPipelineGroupOperateViaNameParamsAnd403);
            before(Routes.Pipeline.SCHEDULE_PATH, mimeType, apiAuthenticationHelper::checkPipelineGroupOperateViaNameParamsAnd403);
            before(Routes.Pipeline.STATUS_PATH, mimeType, apiAuthenticationHelper::checkPipelineGroupOperateViaNameParamsAnd403);
