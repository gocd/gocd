...
public class DataSharingUsageDataServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        goConfig.getElasticConfig().getProfiles().add(new ElasticProfile("docker-profile", "docker-plugin", "prod-cluster"));
        goConfig.getElasticConfig().getProfiles().add(new ElasticProfile("ecs-profile", "ecs-plugin", "prod-cluster"));
