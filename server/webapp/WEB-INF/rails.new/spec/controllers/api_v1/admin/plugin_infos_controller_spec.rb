  ...
  describe 'security' do
    describe 'show' do
      it 'should allow anyone, with security disabled' do
        disable_security
        expect(controller).to allow_action(:get, :show, id: SecureRandom.hex)
      end

      it 'should disallow non-admin user, with security enabled' do
        enable_security
        login_as_user
        expect(controller).to disallow_action(:get, :show, id: SecureRandom.hex).with(401, 'You are not authorized to perform this action.')
      end
