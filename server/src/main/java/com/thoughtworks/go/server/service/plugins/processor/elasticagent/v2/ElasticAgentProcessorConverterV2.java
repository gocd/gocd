...
import com.thoughtworks.go.plugin.access.elastic.v2.AgentMetadataConverterV2;
import com.thoughtworks.go.plugin.access.elastic.v2.AgentMetadataDTO;
...
public class ElasticAgentProcessorConverterV2 implements ElasticAgentProcessorConverter {
    private static final Gson GSON = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();
    private static final AgentMetadataConverterV2 agentMetadataConverter = new AgentMetadataConverterV2();
