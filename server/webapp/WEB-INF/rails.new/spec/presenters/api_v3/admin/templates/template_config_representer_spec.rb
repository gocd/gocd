...
describe ApiV3::Admin::Templates::TemplateConfigRepresenter do
  before :each do
  ...
  it 'should deserialize given json to PipelineTemplateConfig object' do
    ...
    ApiV3::Admin::Templates::TemplateConfigRepresenter.new(deserialized_scm).from_hash(template_hash)
