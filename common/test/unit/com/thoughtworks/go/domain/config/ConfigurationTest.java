...
public class ConfigurationTest {
    ...
    @Test
    public void shouldValidateAllConfigProperties() {
        ConfigurationProperty property = new ConfigurationProperty(new ConfigurationKey("one"), new EncryptedConfigurationValue("foo"));
        Configuration configuration = new Configuration(property);
        configuration.validateProperties(null);
