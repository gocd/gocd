...
public class PackageMetadataStore extends AbstractPackageMetaDataStore {

    private static final PackageMetadataStore packageMetadataStore = new PackageMetadataStore();
