...
class DashboardControllerTest implements SecurityServiceTrait, ControllerTrait<DashboardController> {
  ...
  @Override
  DashboardController createControllerInstance() {
    new DashboardController(new ApiAuthenticationHelper(securityService, goConfigService), pipelineSelectionsService, goDashboardService)
  }
