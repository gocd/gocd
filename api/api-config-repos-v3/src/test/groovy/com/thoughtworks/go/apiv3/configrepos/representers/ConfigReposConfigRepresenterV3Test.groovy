...
class ConfigReposConfigRepresenterV3Test {
  ...
  @Test
  void toJSON() {
    String actual = toObjectString({ w -> ConfigReposConfigRepresenterV3.toJSON(w, new ConfigReposConfig(repo(ID_1), repo(ID_2))) })
