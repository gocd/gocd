...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<representable>, ["<= 3.0.0", ">= 2.0.1"])
      s.add_development_dependency(%q<rake>, [">= 0.10.1"])
      s.add_development_dependency(%q<test_xml>, ["= 0.1.6"])
      s.add_development_dependency(%q<minitest>, [">= 5.4.2"])
      ...
      s.add_dependency(%q<representable>, ["<= 3.0.0", ">= 2.0.1"])
      s.add_dependency(%q<rake>, [">= 0.10.1"])
      s.add_dependency(%q<test_xml>, ["= 0.1.6"])
      s.add_dependency(%q<minitest>, [">= 5.4.2"])
