...
public class ArtifactStoreDeleteCommandTest {
    @Rule
    ...
    public void shouldDeleteAArtifactStore() throws Exception {
        ...
        new ArtifactStoreDeleteCommand(null, artifactStore, null, null, null).update(cruiseConfig);
    ...
    public void shouldRaiseExceptionInCaseArtifactStoreDoesNotExist() throws Exception {
        ...
        new ArtifactStoreDeleteCommand(null, artifactStore, null, null, new HttpLocalizedOperationResult()).update(cruiseConfig);
    ...
    public void shouldNotValidateIfArtifactStoreIsUsedInPipelineConfig() {
        ...
        ArtifactStoreDeleteCommand command = new ArtifactStoreDeleteCommand(null, artifactStore, null, null, new HttpLocalizedOperationResult());
