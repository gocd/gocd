...
class AdminControllerV1Test implements ControllerTrait<AdminControllerV1>, SecurityServiceTrait {
  @Mock
  ...
  @Override
  AdminControllerV1 createControllerInstance() {
    return new AdminControllerV1(new ApiAuthenticationHelper(securityService, goConfigService), entityHashingService, adminsConfigService);
  }
