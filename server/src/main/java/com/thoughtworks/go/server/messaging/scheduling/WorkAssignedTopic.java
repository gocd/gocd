...
@Component
public class WorkAssignedTopic extends GoMessageTopic<WorkAssignedMessage> {

    @Autowired
    public WorkAssignedTopic(MessagingService<GoMessage> messaging) {
        super(messaging, "work_assigned");
    }
}
