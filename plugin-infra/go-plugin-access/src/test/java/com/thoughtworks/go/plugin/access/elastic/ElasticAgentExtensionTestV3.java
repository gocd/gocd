...
public class ElasticAgentExtensionTestV3 extends ElasticAgentExtensionTest {
    ...
    public void setUp() throws Exception {
        super.setUp();
        setExtensionVersionForPluginTo(PLUGIN_ID, "3.0");
    }
    ...
    public void shouldErrorOutForGetStatusReport() throws JSONException {
        ...
        final String statusReportView = extension.getStatusReport(PLUGIN_ID);
    ...
    @Test
    public void shouldErrorOutForGetAgentStatusReport() throws JSONException {
        final String responseBody = "{\"view\":\"<div>This is a status report snippet.</div>\"}";
        final JobIdentifier jobIdentifier = new JobIdentifier("up42", 2, "Test", "up42_stage", "10", "up42_job");
