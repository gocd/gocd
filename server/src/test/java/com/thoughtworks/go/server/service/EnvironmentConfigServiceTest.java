...
class EnvironmentConfigServiceTest {
    ...
    void shouldReturnAllTheLocalEnvironments() {
        ...
        BasicEnvironmentConfig env = (BasicEnvironmentConfig) environmentConfigService.getEnvironmentConfig(uat).getLocal();
        cruiseConfig.addEnvironment(env);
        List<BasicEnvironmentConfig> expectedToEdit = List.of(GoConfigMother.deepClone(env));
    ...
    void shouldReturnAllTheMergedEnvironments() {
        ...
        assertThat(environmentConfigService.getAllMergedEnvironments()).isEqualTo(List.of(env));
    ...
    void getAllLocalPipelinesForUser_shouldReturnAllPipelinesToWhichAlongWithTheEnvironmentsToWhichTheyBelong() {
        ...
        when(mockGoConfigService.getAllLocalPipelineConfigs()).thenReturn(List.of(pipeline1, pipeline2, pipeline3));
        ...
        assertThat(pipelines).isEqualTo(List.of(new EnvironmentPipelineModel(barPipeline), new EnvironmentPipelineModel(fooPipeline, "foo-env")));
    }
    ...
    void getAllLocalPipelinesForUser_shouldReturnOnlyLocalPipelines() {
        ...
        assertThat(pipelines.size()).isEqualTo(2);
        assertThat(pipelines).isEqualTo(List.of(new EnvironmentPipelineModel("bar"), new EnvironmentPipelineModel("foo", "foo-env")));
    }
    ...
    void getAllRemotePipelinesForUserInEnvironment_shouldReturnOnlyRemotelyAssignedPipelinesWhichUserHasPermissionToView() {
        ...
        assertThat(pipelines).isEqualTo(List.of(new EnvironmentPipelineModel("foo", "foo-env")));
    }
    ...
    class EnvironmentForPipeline {
        ...
        void shouldReturnNullIfPipelineIsNotAssociatedWithEnvironment() {
            ...
            assertThat(environmentConfigService.environmentForPipeline("foo")).isNull();
        }
    }
    ...
    class EnvironmentConfigSyncTest {
        ...
        private EnvironmentsConfig createEnvironments(Map<String, String> envNameToAgentMap) {
            ...
            envNameToAgentMap.keySet().forEach(envName -> {
                BasicEnvironmentConfig env = env(envName, null, null, List.of(envNameToAgentMap.get(envName)));
                environments.add(env);
            });
    ...
    void shouldNotUpdateTheCacheIfNullIsPassedForSync() {
        ...
        assertThat(environmentConfigService.getEnvironments().size()).isEqualTo(2);
        assertThat(environmentConfigService.getEnvironmentNames()).contains("uat", "prod");
