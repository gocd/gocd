...
package com.thoughtworks.go.apiv1.artifactstoreconfig.spring;
...
@Component
public class ArtifactStoreConfigController implements SparkSpringController {

    private final ArtifactStoreConfigControllerDelegate delegate;
