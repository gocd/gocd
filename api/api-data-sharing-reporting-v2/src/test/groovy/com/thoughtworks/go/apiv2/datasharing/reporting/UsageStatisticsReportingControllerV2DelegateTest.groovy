...
class UsageStatisticsReportingControllerV2DelegateTest implements SecurityServiceTrait, ControllerTrait<UsageStatisticsReportingControllerV2Delegate> {
    @BeforeEach
    void setUp() {
        initMocks(this)
    }
    ...
    @Override
    UsageStatisticsReportingControllerV2Delegate createControllerInstance() {
        new UsageStatisticsReportingControllerV2Delegate(new ApiAuthenticationHelper(securityService, goConfigService), service)
    }
