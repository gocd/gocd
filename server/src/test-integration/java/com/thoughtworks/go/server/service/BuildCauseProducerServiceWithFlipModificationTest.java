...
public class BuildCauseProducerServiceWithFlipModificationTest {
    ...
    public void setup() throws Exception {
        ...
        svnMaterialConfig = new SvnMaterialConfig(repository.getUrl().rawUrl(), repository.getUserName(), repository.getPassword(), repository.isCheckExternals());
    }
    ...
    private SvnMaterialConfig setUpPipelineWithTwoMaterials() throws Exception {
        SvnMaterialConfig svnMaterialConfig = new SvnMaterialConfig(repository.getUrl().rawUrl(), repository.getUserName(), repository.getPassword(), repository.isCheckExternals());
