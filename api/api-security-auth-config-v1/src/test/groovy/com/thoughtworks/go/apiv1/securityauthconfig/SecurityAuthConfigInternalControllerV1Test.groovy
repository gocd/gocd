...
class SecurityAuthConfigInternalControllerV1Test implements SecurityServiceTrait, ControllerTrait<SecurityAuthConfigInternalControllerV1> {
  ...
  @Override
  SecurityAuthConfigInternalControllerV1 createControllerInstance() {
    new SecurityAuthConfigInternalControllerV1(securityAuthConfigService, new ApiAuthenticationHelper(securityService, goConfigService), entityHashingService)
  }
