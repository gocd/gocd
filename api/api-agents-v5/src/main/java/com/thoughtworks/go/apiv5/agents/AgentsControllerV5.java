...
@Component
public class AgentsControllerV5 extends ApiController implements SparkSpringController {
    private final ApiAuthenticationHelper apiAuthenticationHelper;

    private static final String UNSUPPORTED_API_NAME = "Agents";

    @Autowired
    public AgentsControllerV5(ApiAuthenticationHelper apiAuthenticationHelper) {
        super(ApiVersion.v5);
