...
package com.thoughtworks.go.apiv9.admin.pipelineconfig;
...
@Component
public class PipelineConfigControllerV9 extends ApiController implements SparkSpringController, CrudController<PipelineConfig> {
    ...
    @Autowired
    public PipelineConfigControllerV9(PipelineConfigService pipelineConfigService, PipelinePauseService pipelinePauseService, ApiAuthenticationHelper apiAuthenticationHelper, EntityHashingService entityHashingService, PasswordDeserializer passwordDeserializer, GoConfigService goConfigService, GoCache goCache) {
        super(ApiVersion.v9);
