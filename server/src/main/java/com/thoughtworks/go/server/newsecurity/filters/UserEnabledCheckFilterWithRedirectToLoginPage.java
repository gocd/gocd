...
@Component
public class UserEnabledCheckFilterWithRedirectToLoginPage extends AbstractUserEnabledCheckFilter {

    @Autowired
    public UserEnabledCheckFilterWithRedirectToLoginPage(UserService userService, SecurityService securityService) {
