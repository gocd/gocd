...
class PipelineConfigControllerV8Test implements SecurityServiceTrait, ControllerTrait<PipelineConfigControllerV8> {
  ...
  PipelineConfigControllerV8 createControllerInstance() {
    return new PipelineConfigControllerV8(pipelineConfigService, new ApiAuthenticationHelper(securityService, goConfigService), entityHashingService, passwordDeserializer, goConfigService)
  }
