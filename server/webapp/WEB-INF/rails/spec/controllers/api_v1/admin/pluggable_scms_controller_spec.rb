  ...
  describe "show" do
    describe 'authorization_check' do
      ...
      it 'should disallow anonymous users, with security enabled' do
        ...
        expect(controller).to disallow_action(:get, :show, params: {material_name: 'foo'}).with(403, 'You are not authorized to perform this action.')
      end
  ...
  describe "create" do
    ...
    describe 'admin' do
      ...
      it 'should deserialize scm object from given parameters' do
        ...
        hash = {id: 'scm-id', name: 'foo', auto_update: false, plugin_metadata: {id: 'foo', version: '1'}, configuration: [{"key" => 'url', "value" => 'git@github.com:foo/bar.git'}, {"key" => 'password', "value" => "some-value"}]}.deep_symbolize_keys
  ...
  describe "update" do
    describe 'authorization_check' do
      ...
      it 'should disallow anonymous users, with security enabled' do
        ...
        expect(controller).to disallow_action(:put, :update, params: {material_name: 'foo'}).with(403, 'You are not authorized to perform this action.')
      end
