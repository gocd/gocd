...
import com.thoughtworks.go.apiv2.configrepos.representers.PipelineGroupRepresenter;
...
public class ConfigReposInternalControllerV2 extends ApiController implements SparkSpringController {
    ...
    public void setupRoutes() {
        path(controllerBasePath(), () -> {
            ...
            get(ConfigRepos.PIPELINES_PATH, mimeType, this::definedPipelines);
    ...
    String definedPipelines(Request req, Response res) {
        ConfigRepoConfig repo = repoFromRequest(req);
        PipelineGroups groups = service.pipelinesDefinedBy(repo);
        return jsonizeAsTopLevelArray(req, (w) -> groups.forEach(
