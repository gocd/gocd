...
module ApiV4
  module Config
    class TemplateSummaryRepresenter < ApiV4::BaseRepresenter
      ...
      collection :pipelines, embedded: true, exec_context: :decorator, decorator: ApiV4::Config::PipelineConfigSummaryRepresenter
