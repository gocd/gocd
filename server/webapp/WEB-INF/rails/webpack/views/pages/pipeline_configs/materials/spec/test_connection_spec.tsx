...
describe("Materials: TestConnection", () => {
  ...
  const validMaterial       = new Material("git",
                                           new GitMaterialAttributes("SomeRepo",
    ...
    jasmine.Ajax.withMock(() => {
      ...
      helper.mount(() => <TestConnection material={invalidMaterial} complete={() => {
        ...
        setTimeout(() => { // make this async so as to allow mithril to update the dom
          ...
          expect(helper.byTestId("flash-message-alert").querySelector("pre"))
            .toContainText("Error while parsing material URL");
          done();
        }, 10);
      }}/>);
