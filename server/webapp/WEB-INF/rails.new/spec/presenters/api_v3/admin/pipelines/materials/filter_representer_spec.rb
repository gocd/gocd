...
describe ApiV3::Admin::Pipelines::Materials::FilterRepresenter do
  it 'should serialize' do
    filter      = com.thoughtworks.go.config.materials.Filter.new(IgnoredFiles.new('**/*.html'), IgnoredFiles.new('**/foobar/'))
    presenter   = ApiV3::Admin::Pipelines::Materials::FilterRepresenter.prepare(filter)
  ...
  it 'should deserialize' do
    ...
    presenter       = ApiV3::Admin::Pipelines::Materials::FilterRepresenter.prepare(actual_filter)
