...
public class AuthenticationPluginRegistrarTest {
    ...
    public void shouldRegisterAuthenticationPluginOnLoad() {
        ...
        AuthenticationPluginConfiguration configuration = new AuthenticationPluginConfiguration("plugin 1", "image 1", true, true, true);
    ...
    public void shouldRegisterPluginOnLoadIfNotAuthenticationType() {
        String pluginId = "plugin-id-1";
        when(authenticationExtension.isAuthenticationPlugin(pluginId)).thenReturn(false);
