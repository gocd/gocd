...
public class PluginNotificationListener implements GoMessageListener<PluginNotificationMessage> {
    private final PluginNotificationService pluginNotificationService;

    public PluginNotificationListener(PluginNotificationService pluginNotificationService) {
        this.pluginNotificationService = pluginNotificationService;
    }

    public void onMessage(PluginNotificationMessage message) {
        try {
            pluginNotificationService.notifyPlugins(message);
        } catch (Exception e) {
            // ignore
        }
    }
